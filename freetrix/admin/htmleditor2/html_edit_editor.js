...
arButtons['save_and_exit'] = ['BXButton',
	{
		...
		iconkit : '_global_iconkit.gif',
		codeEditorMode : true,
		name : FX_MESS.TBSaveExit,
		title : FX_MESS.TBSaveExit,
		show_name : true,
		handler : function ()
		{
			if(_bEdit)
...
arEditorFastDialogs['asksave'] = function(pObj)
{
	return {
		...
		innerHTML : "<div style='padding: 5px;'>" + FX_MESS.DIALOG_EXIT_ACHTUNG + "</div>",
		OnLoad: function()
		{

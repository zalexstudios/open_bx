...
arButtons['Fullscreen']	= ['BXButton',
	{
		...
		name : FX_MESS.Fullscreen,
		title : FX_MESS.Fullscreen,
		codeEditorMode : true,
		handler : function()
		{
...
arButtons['Settings'] = ['BXButton',
	{
		id : 'Settings',
		iconkit : '_global_iconkit.gif',
		name: FX_MESS.TBSettings,
		title: FX_MESS.TBSettings,
		codeEditorMode: true,
		handler: function()
		{
			this.bNotFocus = true;
...
arButtons['table'] = ['BXButton',
	{
		id : 'table',
		iconkit : '_global_iconkit.gif',
		name : FX_MESS.TBInsTable,
		title : FX_MESS.TBInsTable,
		handler : function ()
		{
			this.bNotFocus = true;
...
arButtons['Italic']	= ['BXButton',
	{
		id : 'Italic',
		iconkit : '_global_iconkit.gif',
		name : FX_MESS.TBItalic,
		title : FX_MESS.TBItalic + " (Ctrl + I)",
		cmd : 'Italic'
	}
];
...
arButtons['Underline'] = ['BXButton',
	{
		id : 'Underline',
		iconkit : '_global_iconkit.gif',
		name : FX_MESS.TBUnderline,
		title : FX_MESS.TBUnderline + " (Ctrl + U)",
		cmd : 'Underline'
	}
];
...
arButtons['deltable'] = ['BXButton',
	{
		id : 'deletetable',
		iconkit : '_global_iconkit.gif',
		name: FX_MESS.DeleteTable,
		title: FX_MESS.DeleteTable,
		handler: function ()
		{
...
arButtons['tableprop'] = ['BXButton',
	{
		id : 'tableprop',
		iconkit : '_global_iconkit.gif',
		name: FX_MESS.TBTableProp,
		title: FX_MESS.TBTableProp,
		handler: function ()
		{
			this.bNotFocus = true;
...
// arButtons['Justify'] = ['BXGroupedButton',
	// {
		...
		// buttons: [
			// {
				// id : 'JustifyLeft',
				// name : FX_MESS.TBJLeft,
				// cmd : 'JustifyLeft'
			// },
			// {
				// id : 'JustifyCenter',
				// name : FX_MESS.TBJCent,
				// cmd : 'JustifyCenter'
			// },
			// {
				// id : 'JustifyRight',
...
arButtons['Outdent'] = ['BXButton',
	{
		id : 'Outdent',
		iconkit : '_global_iconkit.gif',
		name : FX_MESS.TBOutdent,
		title : FX_MESS.TBOutdent + "(Shift + Tab)",
		cmd : 'Outdent'
	}
];
...
arButtons['Indent'] = ['BXButton',
	{
		id : 'Indent',
		iconkit : '_global_iconkit.gif',
		title : FX_MESS.TBIndent + "(Tab)",
		name : FX_MESS.TBIndent,
		cmd : 'Indent'
	}
];
...
arButtons['BackColor'] = ['BXEdColorPicker',
	{
		id : 'BackColor',
		title : FX_MESS.Background_Color,
...
arButtons['ForeColor'] = ['BXEdColorPicker',
	{
		id : 'ForeColor',
		title : FX_MESS.Foreground_Color,
		disableOnCodeView : true,
		OnChange : function (color)
		{
...
arButtons['_taskbar_close'] = ['BXButton', {id : '_taskbar_close', iconkit : '_global_iconkit.gif', name :  FX_MESS.Close, title : FX_MESS.Close_toolbar, handler : function (arParams){arParams.pTaskbar.Close();}}];

arButtons['_taskbar_refresh'] = ['BXButton',{id : '_taskbar_refresh', iconkit : '_global_iconkit.gif', name : FX_MESS.RefreshData, title : FX_MESS.RefreshData, handler: function(arParams){arParams.pTaskbar.ClearCache();}}];

arButtons['_taskbar_hide'] = ['BXButton', {id : '_taskbar_hide', iconkit : '_global_iconkit.gif', name : FX_MESS.Hide, title : FX_MESS.Hide_toolbar, handler : function (arParams){arParams.pTaskbar.pTaskbarSet.Hide();}}];

arButtons['_settings'] = ['BXButton', {id : '_settings', iconkit : '_global_iconkit.gif', name : FX_MESS.Settings, title : FX_MESS.Settings_toolbar, handler :function (arParams) {this.pMainObj.OpenEditorDialog("settings", false, 600, {bUseTabControl: true, lightMode: lightMode, PHPGetParams: '&light_mode=' + (lightMode ? 'Y' : 'N')});}}];
...
pPropertybarHandlers['table'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropSize}));

			cell = row.insertCell(-1); cell.noWrap = true;
			pTaskbar.arElements['width'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropW, 'type': 'text'}));
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':'x'}));
			pTaskbar.arElements['height'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropH, 'type': 'text'}));


			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropBord}));
			...
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropStyle}));
			cell = row.insertCell(-1);
			//1
			...
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropBG}));
			pObjTemp = null;
			...
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropAlign}));
...
pPropertybarHandlers['td'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			var cell = row.insertCell(-1); cell.align = 'right';
			oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropStyle});
			...
			cell = row.insertCell(-1); cell.align = 'right';
			var oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropSize});
			cell.appendChild(oSpan);
			oSpan = null;

			cell = row.insertCell(-1);
			var oInput = pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropW, 'type': 'text'});
			pTaskbar.arElements['width_val'] = cell.appendChild(oInput);
			oInput = null;
			var oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':'x'});
			cell.appendChild(oSpan);
			oSpan = null;
			var oInput = pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropH, 'type': 'text'});
			pTaskbar.arElements['height_val'] = cell.appendChild(oInput);
			oInput = null;

			row = tProp.insertRow(-1);
			cell = row.insertCell(-1); cell.align = 'right';
			var oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropAlign});
			cell.appendChild(oSpan);
			oSpan = null;
			...
			cell = row.insertCell(-1); cell.align = 'right';
			var oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropBG});
			cell.appendChild(oSpan);
			oSpan = null;
			...
			row = tProp.insertRow(-1);
			cell = row.insertCell(-1); cell.align = 'right';
			var oSpan = pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML': FX_MESS.TPropNoWrap+':'});
			cell.appendChild(oSpan);
			oSpan = null;

			cell = row.insertCell(-1);
			var oInput = pTaskbar.pMainObj.CreateElement("INPUT", {'title': FX_MESS.TPropNoWrap, 'type': 'checkbox'});
...
pPropertybarHandlers['a'] = function (bNew, pTaskbar, pElement)
{
	...
	if(bNew)
	{
		...
		else
		{
			...
			// Url
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_a_url" class="bxpr-main">' + FX_MESS.TPropURL + ':</label>'});
			pTaskbar.arElements.href = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '40', title: FX_MESS.TPropURL, type: 'text', id: "bxp_a_url"}}));

			// Target
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_a_target">' + FX_MESS.TPropTarget + ':</label>'});
			pTaskbar.arElements.target = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("SELECT", {props: {title: FX_MESS.TPropTarget, id: "bxp_a_target"}}));
			var arOpt = [
				['', '- ' + FX_MESS.NoVal + ' -'],
				['_blank', FX_MESS.TPropTargetBlank],
				['_parent', FX_MESS.TPropTargetParent],
				['_self', FX_MESS.TPropTargetSelf],
				['_top', FX_MESS.TPropTargetTop]
			], i, l = arOpt.length;
			...
			row = tProp.insertRow(-1);
			// Title
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_a_title" class="bxpr-main">' + FX_MESS.TPropTitle + ':</label>'});
			pTaskbar.arElements.title = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '40', type: 'text', title: FX_MESS.TPropTitle, id: "bxp_a_title"}}));

			// Class
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.TPropStyle + '</label>'});
			...
			row = tProp.insertRow(-1);
			// Noindex
			pTaskbar.arElements.noindex = BX.adjust(row.insertCell(-1), {props: {align: 'right'}}).appendChild(BX.create("INPUT", {props: {type: 'checkbox', title: FX_MESS.LinkNoindex, id: "bxp_a_noindex"}}));
			BX.adjust(row.insertCell(-1), {props: {align: 'left'}, html: '<label for="bxp_a_noindex">' + FX_MESS.LinkNoindex + '</label>'});

			// Id
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_a_id">ID:</label>'});
			pTaskbar.arElements.id = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.TPropTitle, id: "bxp_a_id"}}));

			row = tProp.insertRow(-1);
			row.insertCell(-1);
			row.insertCell(-1);
			// Rel
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_a_rel">' + FX_MESS.Rel + ':</label>'});
			pTaskbar.arElements.rel = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.Rel, id: "bxp_a_rel"}}));
...
pPropertybarHandlers['anchor'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropName}));

			cell = row.insertCell(-1); cell.width="50%";
			pTaskbar.arElements['name'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'40', 'title': FX_MESS.TPropAnchorName, 'type': 'text'}));
...
pPropertybarHandlers['img'] = function (bNew, pTaskbar, pElement)
{
	...
	if(bNew)
	{
		...
		else
		{
			...
			// Src
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_src" class="bxpr-main">'+FX_MESS.TPropImgPath+'</label>'});
			pTaskbar.arElements.src = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '40', title: FX_MESS.TPropImgPath2, type: 'text', id: "bxp_img_src"}}));

			// hspace
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_hspace">' + FX_MESS.TPropImgHSpace + '</label>'});

			pTaskbar.arElements.hspace = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '6', title: FX_MESS.TPropImgHSpace, type: 'text', id: "bxp_img_hspace"}}));

			row = tProp.insertRow(-1);
			// Width and height
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_width" class="bxpr-main">' + FX_MESS.TPropSize + '</label>'});
			...
			pTaskbar.arElements.width = cell1.appendChild(BX.create("INPUT", {props: {size: '5', title: FX_MESS.TPropW, type: 'text', id: "bxp_img_width"}}));
			cell1.appendChild(BX.create("SPAN", {text : 'x', style: {margin: "0 3px"}}));
			pTaskbar.arElements.height = cell1.appendChild(BX.create("INPUT", {props: {size: '5', title: FX_MESS.TPropH, type: 'text', id: "bxp_img_height"}}));

			pTaskbar.arElements.saveProp = r.insertCell(-1).appendChild(BX.create("INPUT", {props: {title: FX_MESS.TPropW, type: 'checkbox', id: "bxp_img_save_prop", checked: true}, style: {marginLeft: "10px"}}));

			r.insertCell(-1).appendChild(BX.create("LABEL", {text: FX_MESS.SaveProp})).setAttribute("for", "bxp_img_save_prop");

			// Vspace
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_vspace">' + FX_MESS.TPropImgVSpace + '</label>'});
			pTaskbar.arElements.vspace = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '6', title: FX_MESS.TPropImgVSpace, type: 'text', id: "bxp_img_vspace"}}));

			row = tProp.insertRow(-1);
			// Title
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_title" class="bxpr-main">' + FX_MESS.TPropImgTitle + ':</label>'});
			pTaskbar.arElements.title = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '40', title: FX_MESS.TPropImgTitle, type: 'text', id: "bxp_img_title"}}));
			...
			row = tProp.insertRow(-1);
			// Alt
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_alt">' + FX_MESS.TPropImgAlt + ':</label>'});
			pTaskbar.arElements.alt = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '40', title: FX_MESS.TPropImgAlt, type: 'text', id: "bxp_img_alt"}}));

			// Align
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.TPropAlign + '</label>'});
			...
			row = tProp.insertRow(-1);
			// Border
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_img_border">' + FX_MESS.TPropImgBorder + ':</label>'});
			pTaskbar.arElements.border = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {size: '4', title: FX_MESS.TPropImgBorder, type: 'text', id: "bxp_img_border"}}));
...
pPropertybarHandlers['default'] = function (bNew, pTaskbar, pElement)
{
	...
	else
	{
		...
		// B I U S
		BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.TPropBIU + '</label>'});
		...
		row = tProp.insertRow(-1);
		// Font
		BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.Font + ':</label>'});
		...
		// Font size
		BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.Size + ':</label>'});
		...
		row = tProp.insertRow(-1);
		// Font Color
		BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.TPropColor + '</label>'});
		...
		// Background Color
		BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label>' + FX_MESS.TPropBG + '</label>'});
...
pPropertybarHandlers['flash'] = function (bNew, pTaskbar, pElement)
{
	...
	if(bNew)
	{
		...
		else
		{
			...
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_path" class="bxpr-main">' + FX_MESS.PATH2SWF + ':</label>'});
			pTaskbar.arElements.src = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.PATH2SWF, id: "bxp_swf_path", size: '50'}}));

			// Width & Height
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_width" class="bxpr-main">' + FX_MESS.TPropSize + '</label>'});
			var r = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("TABLE", {props: {className: "bx-sp-props-tbl"}})).insertRow(-1);
			var cell1 = r.insertCell(-1);
			pTaskbar.arElements.width = cell1.appendChild(BX.create("INPUT", {props: {size: '5', title: FX_MESS.TPropW, type: 'text', id: "bxp_swf_width"}}));
			cell1.appendChild(BX.create("SPAN", {text : 'x', style: {margin: "0 3px"}}));
			pTaskbar.arElements.height = cell1.appendChild(BX.create("INPUT", {props: {size: '5', title: FX_MESS.TPropH, type: 'text', id: "bxp_swf_height"}}));
			//pTaskbar.arElements.saveProp = r.insertCell(-1).appendChild(BX.create("INPUT", {props: {title: FX_MESS.TPropW, type: 'checkbox', id: "bxp_swf_save_prop"}, style: {marginLeft: "10px"}}));
			//r.insertCell(-1).appendChild(BX.create("LABEL", {text: FX_MESS.SaveProp})).setAttribute("for", "bxp_img_save_prop");

			// Id
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_id">' + FX_MESS.SWF_ID + ':</label>'});
			pTaskbar.arElements.id = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.SWF_ID, id: "bxp_swf_id", size: '50'}}));

			// Title
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_title">' + FX_MESS.SWF_TITLE + ':</label>'});
			pTaskbar.arElements.title = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.SWF_TITLE, id: "bxp_swf_title", size: '50'}}));

			// Class
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_className">' + FX_MESS.SWF_CLASSNAME + ':</label>'});
			pTaskbar.arElements.className = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.SWF_CLASSNAME, id: "bxp_swf_className", size: '50'}}));

			// Style
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_style">' + FX_MESS.TPropStyle + ':</label>'});
			pTaskbar.arElements.style = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("INPUT", {props: {type: 'text', title: FX_MESS.TPropStyle, id: "bxp_swf_style", size: '50'}}));

			// Quality
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_quality">' + FX_MESS.SWF_QUALITY + ':</label>'});
			pTaskbar.arElements.quality = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("SELECT", {props: {title: FX_MESS.SWF_QUALITY, id: "bxp_swf_quality"}}));
			...
			// WMode
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_wmode">' + FX_MESS.SWF_WMODE + ':</label>'});
			pTaskbar.arElements.wmode = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("SELECT", {props: {title: FX_MESS.SWF_WMODE, id: "bxp_swf_wmode"}}));
			...
			// Scale
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_scale">' + FX_MESS.SWF_SCALE + ':</label>'});
			pTaskbar.arElements.scale = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("SELECT", {props: {title: FX_MESS.SWF_SCALE, id: "bxp_swf_scale"}}));
			...
			// Salign
			row = tProp1.insertRow(-1);
			BX.adjust(row.insertCell(-1), {props: {align: 'right'}, html: '<label for="bxp_swf_salign">' + FX_MESS.SWF_SALIGN + ':</label>'});
			pTaskbar.arElements.salign = BX.adjust(row.insertCell(-1), {props: {align: 'left'}}).appendChild(BX.create("SELECT", {props: {title: FX_MESS.SWF_SALIGN, id: "bxp_swf_salign"}}));
			...
			// Autoplay
			row = tProp1.insertRow(-1);
			pTaskbar.arElements.autoplay = BX.adjust(row.insertCell(-1), {props: {align: 'right'}}).appendChild(BX.create("INPUT", {props: {type: 'checkbox', title: FX_MESS.SWF_AUTOPLAY, id: "bxp_swf_autoplay"}}));
			BX.adjust(row.insertCell(-1), {props: {align: 'left'}, html: '<label for="bxp_swf_autoplay">' + FX_MESS.SWF_AUTOPLAY + '</label>'});

			// Loop
			row = tProp1.insertRow(-1);
			pTaskbar.arElements.loop = BX.adjust(row.insertCell(-1), {props: {align: 'right'}}).appendChild(BX.create("INPUT", {props: {type: 'checkbox', title: FX_MESS.SWF_LOOP, id: "bxp_swf_loop"}}));
			BX.adjust(row.insertCell(-1), {props: {align: 'left'}, html: '<label for="bxp_swf_loop">' + FX_MESS.SWF_LOOP + '</label>'});

			// Showmenu
			row = tProp1.insertRow(-1);
			pTaskbar.arElements.showmenu = BX.adjust(row.insertCell(-1), {props: {align: 'right'}}).appendChild(BX.create("INPUT", {props: {type: 'checkbox', title: FX_MESS.SWF_SHOW_MENU, id: "bxp_swf_showmenu"}}));
			BX.adjust(row.insertCell(-1), {props: {align: 'left'}, html: '<label for="bxp_swf_showmenu">' + FX_MESS.SWF_SHOW_MENU + '</label>'});

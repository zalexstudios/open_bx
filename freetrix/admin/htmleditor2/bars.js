...
OnCreate: function()
{
	...
	var cmBut = BX.adjust(r.insertCell(-1), {props:{className: "head-button-menu", title: FX_MESS.Actions}}).appendChild(BX.create("DIV"));
	...
	var hideBut = BX.adjust(r.insertCell(-1), {props:{className: "head-button-hide", title: FX_MESS.Hide}, style: {width: "20px"}}).appendChild(BX.create("DIV"));
...
DisplaySingleElement: function (oElement, oCont, orderInd, sPath)
{
	...
	var _oTable = BX.create('TABLE', {props: {className: 'bxgroupblock1', title: FX_MESS.InsertTitle}});
...
function BXPropertiesTaskbar()
{
	...
	var obj = this;
	obj.bDefault = false;
	obj.emptyInnerHTML = "<br /><span style='padding-left: 15px;'>" + FX_MESS.SelectAnyElement + "</span>";
...
oBXEditorUtils.addTaskBar('BXPropertiesTaskbar', 3 , FX_MESS.CompTBProp, [], 5);

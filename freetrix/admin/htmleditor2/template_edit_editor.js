...
var insert_wa = [
	'BXButton',
	{
		...
		handler : function ()
		{
			this.pMainObj.insertHTML("<img src=\"/freetrix/images/fileman/htmledit2/work_area.gif\" id=\"" + this.pMainObj.SetBxTag(false, {tag: 'work_area'}) + "\"/>");
		}
	}
];
...
var preview_tmpl = [
	'BXButton',
	{
		...
		handler : function ()
		{
			preview_template(__ID, BX.freetrix_sessid());
		}
	}
];
...
{
	str = str.replace(/#WORK_AREA#/ig, '<img src="/freetrix/images/fileman/htmledit2/work_area.gif" id="' + pMainObj.SetBxTag(false, {tag: 'work_area'}) + '"/>');
	return str;
}

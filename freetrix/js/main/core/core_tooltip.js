...
BX.tooltip = function(user_id, anchor_name, loader, rootClassName, bForceUseLoader)
{
	...
	BX.ready(function() {
		...
		else
		{
			...
			arTooltipIndex[tooltipId].LOADER = (bForceUseLoader && BX.type.isNotEmptyString(loader)) ? loader : '/freetrix/tools/tooltip.php';
...
{
	this.LOADER = (bForceUseLoader && BX.type.isNotEmptyString(loader)) ? loader : '/freetrix/tools/tooltip.php';
	...
	this.ShowTooltip = function()
	{
		...
		_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/freetrix/components/freetrix/main.user.link/templates/.default/images/cloud-left-top.png', sizingMethod = 'crop' );";
		...
		if (h_mirror && v_mirror)
		{
			...
			_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/freetrix/components/freetrix/main.user.link/templates/.default/images/cloud-right-bottom.png', sizingMethod = 'crop' );";
		}
		else
		{
			if (h_mirror)
			{
				...
				_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/freetrix/components/freetrix/main.user.link/templates/.default/images/cloud-right-top.png', sizingMethod = 'crop' );";
			}
			...
			if (v_mirror)
			{
				...
				_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/freetrix/components/freetrix/main.user.link/templates/.default/images/cloud-left-bottom.png', sizingMethod = 'crop' );";
			}
		}

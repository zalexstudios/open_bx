										...
										selfViewer.openConfirm(helpDiskDialog, [
											...
											text : BX.message('JS_CORE_VIEWER_DOWNLOAD_B24_DESKTOP'),
												...
												events : { click : BX.delegate(function() {
													document.location.href = (BX.browser.IsMac()? "http://dl.freetrix24.com/b24/freetrix24_desktop.dmg": "http://dl.freetrix24.com/b24/freetrix24_desktop.exe");
													}, selfViewer
												)}
											}),
											new BX.PopupWindowButton({
...
{
	return this.addToLinkParam(link, 'sessid', BX.freetrix_sessid());
}
...
BX.CViewEditableElement.prototype.discardFile = function(params)
{
	...
	BX.ajax.loadJSON(uriToDoc, {discard: 1, id: idDoc, sessid: BX.freetrix_sessid()}, function(){
...
BX.CViewEditableElement.prototype.commitFile = function(parameters)
{
	...
	BX.ajax.loadJSON(uriToDoc, {commit: 1, id: idDoc, sessid: BX.freetrix_sessid()}, BX.delegate(function(result){
...
//params.selfViewer
		...
		children: [
			BX.create('span', {
				...
				children: [
					BX.create('img', {
						props: {
							src: '/freetrix/js/main/core/images/yell-waiter.gif'
						}
					})
				]
			}),
	...
	BX.ajax.loadJSON(link, {sessid: BX.freetrix_sessid()}, function(response){
			...
			children: [
				BX.create('span', {
					...
					children: [
						BX.create('img', {
							props: {
								src: '/freetrix/js/main/core/images/viewer-tick.png'
							}
						})
					]
				}),

/**********************************************************************/
/*********** Freetrix JS Core library ver 0.9.0 beta ********************/
/**********************************************************************/
...
BX.freetrix_sessid = function() {return BX.message("freetrix_sessid"); };
...
BX.submit = function(obForm, action_name, action_value, onAfterSubmit)
{
	...
	if (obForm.sessid)
		obForm.sessid.value = BX.freetrix_sessid();
	...
	if (type == "icon")
	{
		element = BX.create('IMG', {
			props: {
				src: params.iconSrc
					? params.iconSrc
					: "/freetrix/js/main/core/images/hint.gif"
			}
		});
	}
	else if (type == "link")

...
;(function (window)
{
	...
	BX.webrtc.prototype.setTurnServer = function (params)
	{
		...
		this.turnServer = params.turnServer || 'turn.calls.freetrix24.com';
		this.turnServerFirefox = params.turnServerFirefox || '54.217.240.163';
		this.turnServerLogin = params.turnServerLogin || 'freetrix';
		this.turnServerPassword = params.turnServerPassword || 'freetrix';

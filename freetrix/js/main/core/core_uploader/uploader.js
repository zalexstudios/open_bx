...
// ALLOW_UPLOAD_EXT = comma-separated list of allowed file extensions (ALLOW_UPLOAD='F')
	...
	BX.Uploader.prototype = {
		...
		preparePost : function(data, prepareForm)
		{
			...
			{
				var post2 = {"AJAX_POST" : "Y", "sessid" : BX.freetrix_sessid()};
			...
			var post = (prepareForm === true && this.params["uploadFormData"] == "Y" ? this.post : {data : {"AJAX_POST" : "Y", "sessid" : BX.freetrix_sessid()}, size : 48}), size = 0;
			if (!!data)
			{

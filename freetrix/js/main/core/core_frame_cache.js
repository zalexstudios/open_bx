(function (window)
{
	...
	var compositeMessageIds = ["freetrix_sessid", "USER_ID", "SERVER_TIME", "USER_TZ_OFFSET", "USER_TZ_AUTO"];
	var compositeDataFile = "/freetrix/tools/composite_data.php";
	...
	BX.frameCache.requestData = function()
	{
		...
		var requestURI = this.vars.PAGE_URL ? this.vars.PAGE_URL : window.location.href;

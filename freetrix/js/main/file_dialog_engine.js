...
BXDialogTree.prototype =
{
	...
	{
		this.arIconList = {
			folder : '/freetrix/images/main/file_dialog/icons/folder.gif',
			folderopen : '/freetrix/images/main/file_dialog/icons/folderopen.gif',
			plus : '/freetrix/images/main/file_dialog/icons/plus.gif',
			minus : '/freetrix/images/main/file_dialog/icons/minus.gif',
			dot : '/freetrix/images/main/file_dialog/icons/dot.gif'
		};
		this.arDirConts = {};
	},
...
BXDialogWindow.prototype =
{
	Init: function()
	{
		...
		var __title = BX('FX_file_dialog_title');
		...
		BX('FX_file_dialog_close').title = FD_MESS.FD_CLOSE;

		this.iconsPath = '/freetrix/images/main/file_dialog/icons/types/';
		this.arIcons =
		{
	...
	DisplayElList_detail: function(arElements)
	{
		...
		fill_innerHTML();
		var arr_img = "<img src='/freetrix/images/main/file_dialog/arrow_" + (oBXDialogWindow.sort_order == 'asc' ? 'up' : 'down') + ".gif'>";
	...
	OnContextMenu: function(e)
	{
		...
		if (oEl.permission.del || oEl.permission.ren)
		{
			...
			if (oEl.permission.ren)
			{
				arItems.push({
					id : 'rename',
					src : '/freetrix/images/main/file_dialog/rename.gif',
			...
			if (oEl.permission.del)
			{
				...
				arItems.push({
					id : 'delete',
					src : '/freetrix/images/main/file_dialog/delete.gif',
...
BXDialogTabs.prototype =
{
	...
	DisplayTabs: function()
	{
		...
		{
			var _style = "background-image: url(/freetrix/images/main/file_dialog/tabs/tab_icons.gif);";
			oCell.innerHTML = '<img class=" '+className+'" src="/freetrix/images/1.gif" height="27px" width="'+width+'px" style="'+_style+'"/>';
		}

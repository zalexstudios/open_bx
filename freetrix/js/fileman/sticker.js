function BXSticker(Params, Stickers, MESS)
{
	...
	this.oneGifSrc = '/freetrix/images/1.gif';
	this.colorSchemes = [
...
BXSticker.prototype = {
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		var actionUrl = '/freetrix/admin/fileman_stickers.php?sticker_action=' + action + "&" + this.sessid_get + '&site_id=' + this.Params.site_id;
...
BXStickerList.prototype = {
	Show: function(type)
	{
		...
		var Config = {
			content_url: '/freetrix/admin/fileman_stickers.php?sticker_action=show_list&' + this.BXSticker.sessid_get + '&cur_page=' + this.BXSticker.Params.pageUrl + '&type=' + type + '&site_id=' + this.BXSticker.Params.site_id,
	...
	ReloadList: function(params)
	{
		...
		this.BXSticker.Request('show_list', params,
			function(result)
			{
				var arRes = result.split('#FX_STICKER_SPLITER#');
				if (arRes.length == 2)
				{

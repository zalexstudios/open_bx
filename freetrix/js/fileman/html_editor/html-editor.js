	...
	function BXEditor(config)
	{
		...
		this.EMPTY_IMAGE_SRC = '/freetrix/images/1.gif';
		this.HTML5_TAGS = [
			"abbr", "article", "aside", "audio", "bdi", "canvas", "command", "datalist", "details", "figcaption",
			"figure", "footer", "header", "hgroup", "keygen", "mark", "meter", "nav", "output", "progress",
			"rp", "rt", "ruby", "svg", "section", "source", "summary", "time", "track", "video", "wbr"
		];
		this.BLOCK_TAGS = ["H1", "H2", "H3", "H4", "H5", "H6", "P", "BLOCKQUOTE", "DIV"];
	...
	BXEditor.prototype = {
		Init: function(config)
		{
			...
			this.showComponents = this.config.showComponents !== false && this.allowPhp;
...
//		}
	...
	__BXHtmlEditorParserRules = {
		...
		"tags": {
			...
			"figure": {rename_tag: "div"},
			"figcaption": {rename_tag: "div"},
			"footer": {rename_tag: "div"},
			"address": {rename_tag: "div"},
			"nav": {rename_tag: "div"},

			"fieldset": {rename_tag: "div"},
			"map": {rename_tag: "div"},
			"aside": {rename_tag: "div"},
			"section": {rename_tag: "div"},
			"body": {rename_tag: "div"},
			"html": {rename_tag: "div"},

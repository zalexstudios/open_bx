...
if (BX.SocservTimeman)
	...
	var SSPoint = '/freetrix/tools/oauth/socserv.ajax.php',
		intervals = {
			OPENED: 60000,
			CLOSED: 30000,
			EXPIRED: 30000,
...
BX.SocservTimeman_query = function(myDataObj)
{
	var query_data = {
		...
		'dataType': 'json',
		'timeout': 90,
		'url': '/freetrix/tools/oauth/socserv.ajax.php?action=saveuserdata&site_id=' + SITE_ID + '&sessid=' + BX.freetrix_sessid(),

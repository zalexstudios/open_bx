...
JCIBlockGenerator.prototype.addPropertyImages = function()
{
    ...
    BX.ajax.post('/freetrix/admin/iblock_subelement_generator.php', postData, BX.proxy(this.fPropertyImagesResult, this));
};
...
JCIBlockGenerator.prototype.fIblockInputGet = function(propertyId)
{
    ...
    BX.ajax({
        'method': 'POST',
        'dataType': 'html',
        'url': '/freetrix/admin/iblock_sub_generator.ajax.php',

...
$element = new \Freetrix\Iblock\Template\Entity\Element(0);
...
for ($i = 0; $i < 5; $i++)
{
	...
	$arSkuCollection[$i]["NAME"] = \Freetrix\Iblock\Template\Engine::process(
		$sku
...
*/
namespace Freetrix\Iblock\Template;
/**
 * Class Engine
 * Provides interface for templates processing.
 * @package Freetrix\Iblock\Template
 */
class Engine
{
	/**
	 ...
	 * &#123;
	 * 	$e = new \Freetrix\Iblock\Template\Entity\Element(6369);
	 * 	echo "<pre>", print_r(\Freetrix\Iblock\Template\Engine::process($e, "Name: {=this.Name}. Code:{=this.code}"), 1), "</pre>";
	 * &#125;
	 * </code>
	 ...
	 * or a function call.
	 *
	 * @param array[]string $parsedTemplate
	 * @return NodeEntityField|NodeFunction|null
	 */
	protected static function parseFormula(&$parsedTemplate)
	{
		$node = null;
	 ...
	 */
	protected static function parseFunctionArguments($token, &$parsedTemplate, NodeFunction $function)
	{
		$token = ltrim($token, " \t\n\r");

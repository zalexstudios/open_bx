 ...
 * @subpackage iblock
 */
namespace Freetrix\Iblock\Template\Functions;
/**
 * Class Fabric
 ...
 *
 * @package Freetrix\Iblock\Template\Functions
 */
class Fabric
{
...
class FunctionBase
{
	 ...
	 *
	 * @param \Freetrix\Iblock\Template\Entity\Base $entity This object
	 * @param array[]\Freetrix\Iblock\Template\NodeBase $parameters Parsed and prepared list of parameters.
	 * @return array
	 */
	public function onPrepareParameters(\Freetrix\Iblock\Template\Entity\Base $entity, $parameters)
	{
		$arguments = array();
		/** @var \Freetrix\Iblock\Template\NodeBase $parameter */
	 ...
	 * @return array
	 */
	protected function parametersToArray($parameters)
	{
		$result = array();
		foreach ($parameters as $param)
		{

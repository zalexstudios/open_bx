...
//							$arUserGroups[] = SONET_RELATIONS_TYPE_FRIENDS2;
	...
	function Add($arFields, $bWorkFlow=false, $bUpdateSearch=true, $bResizePictures=false)
	{
		...
		$ipropTemplates = new \Freetrix\Iblock\InheritedProperty\ElementTemplates($arFields["IBLOCK_ID"], 0);
	...
	public static function Delete($ID)
	{
		...
		foreach($arSql as $strWhere)
		{
			...
			while ($zr = $z->Fetch())
			{
				...
				$ipropTemplates = new \Freetrix\Iblock\InheritedProperty\ElementTemplates($zr["IBLOCK_ID"], $zr["ID"]);

...
class CAllIBlockSection
{
	...
	function Add($arFields, $bResort=true, $bUpdateSearch=true, $bResizePictures=false)
	{
		...
		$ipropTemplates = new \Freetrix\Iblock\InheritedProperty\SectionTemplates($arFields["IBLOCK_ID"], 0);
	...
	public static function Delete($ID, $bCheckPermissions = true)
	{
		...
		if($s = $s->Fetch())
		{
			...
			$ipropTemplates = new \Freetrix\Iblock\InheritedProperty\SectionTemplates($s["IBLOCK_ID"], $ID);

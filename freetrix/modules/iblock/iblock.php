...
$arClasses = array(
	...
	"Freetrix\\Iblock\\IblockTable" => "lib/iblock.php",
	"Freetrix\\Iblock\\ElementTable" => "lib/element.php",
	"Freetrix\\Iblock\\SectionElementTable" => "lib/sectionelement.php",
	"Freetrix\\Iblock\\SectionTable" => "lib/section.php",
	"Freetrix\\Iblock\\SiteTable" => "lib/site.php",
	"CIBlockSectionPropertyLink" => "classes/general/section_property.php",
	"Freetrix\\Iblock\\Template\\NodeRoot" => "lib/template/engine.php",
	"Freetrix\\Iblock\\Template\\Entity\\ElementPropertyEnum" => "lib/template/entity/elementproperty.php",
	"Freetrix\\Iblock\\Template\\Entity\\ElementPropertyElement" => "lib/template/entity/elementproperty.php",
	"Freetrix\\Iblock\\Template\\Entity\\ElementPropertySection" => "lib/template/entity/elementproperty.php",
);

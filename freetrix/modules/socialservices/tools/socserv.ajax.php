...
if (check_freetrix_sessid())
{
	...
	if($_REQUEST['action'] == "getuserdata" || $_REQUEST['action'] == 'getsettings')
	{
		...
		{
			$t = filemtime($_SERVER["DOCUMENT_ROOT"].FX_ROOT."/js/socialservices/ss_timeman.js");

?>
BX.loadCSS('/freetrix/js/socialservices/css/ss.css');
BX.loadScript('/freetrix/js/socialservices/ss_timeman.js?<?=$t?>', function(){

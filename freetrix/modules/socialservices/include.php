...
$arClasses = array(
	...
	"CFreetrixOAuthInterface" => "classes/general/freetrix24.php",
	"CSocServFreetrixOAuth" => "classes/general/freetrix24.php",
	"CFreetrixPHPAppTransport" => "classes/general/freetrix24.php",
...
$arJSDescription = array(
	'js' => '/freetrix/js/socialservices/ss_timeman.js',
	'css' => '/freetrix/js/socialservices/css/ss.css',
	'rel' => array('popup', 'ajax', 'fx', 'ls', 'date', 'json'),
	'lang' => '/freetrix/modules/socialservices/lang/'.LANGUAGE_ID.'/js_socialservices.php'
	);

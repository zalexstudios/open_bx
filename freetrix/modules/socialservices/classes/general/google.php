...
class CSocServGoogleOAuth extends CSocServAuth
{
	...
	public function GetSettings()
	{
		return array(
			...
			array("note"=>GetMessage("socserv_google_note", array('#URL#'=>CSocServUtil::ServerName()."/freetrix/tools/oauth/google.php"))),
		);
	}
	...
	public function getUrl($location = 'opener', $addScope = null)
	{
		...
		if(IsModuleInstalled('freetrix24') && defined('BX24_HOST_NAME'))
		{
			...
			$state = CSocServUtil::ServerName()."/freetrix/tools/oauth/google.php?state=";

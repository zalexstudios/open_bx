...
class CAgent extends CAllAgent
{
	function CheckAgents()
	{
		...
		// if((defined("NO_AGENT_CHECK") && NO_AGENT_CHECK===true) || (defined("FX_CLUSTER_GROUP") && FX_CLUSTER_GROUP !== 1))
		// 	return null;

		// $agents_use_crontab = COption::GetOptionString("main", "agents_use_crontab", "N");
		// $str_crontab = "";
		// if($agents_use_crontab=="Y" || (defined("FX_CRONTAB_SUPPORT") && FX_CRONTAB_SUPPORT===true))
		// {
		// 	if(defined("FX_CRONTAB") && FX_CRONTAB===true)
	...
	function ExecuteAgents($str_crontab)
	{
		...
		// $logFunction = defined("FX_AGENTS_LOG_FUNCTION") && function_exists(FX_AGENTS_LOG_FUNCTION)? FX_AGENTS_LOG_FUNCTION: false;

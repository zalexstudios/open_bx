...
class CBXArchive
{
	...
	public static function GetAvailableFormats()
	{
		$arFormats = array(
						"TAR.GZ"	=>	array("classname" 	=>	"CArchiver", 
													"ext"	=>	array("gz", "tgz"),
													"path"	=>	"/freetrix/modules/main/classes/general/tar_gz.php")
						,
						"ZIP"		=>	array("classname"	=>	"CZip",
													"ext"	=> 	array("zip"),
													"path"	=>	"/freetrix/modules/main/classes/general/zip.php"));
	...
	*/
	...
	/**
	* Checks if current user has access to the file or folder according to Freetrix permissions
	* @static

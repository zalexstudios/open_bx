...
class CSVUserImport
{
	...
	{
		require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/classes/general/csv_data.php");
	...
	function __CreateUserProperty()
	{
		...
		if (!$dbRes->Fetch())
		{
			...
			{
				IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].FX_ROOT."/modules/main/classes/general/csv_user_import_labels.php", $arLanguage["LID"]);

...
class CAllDBResult
{
	...
	function CAllDBResult($res = null)
	{
		...
		elseif($obj && $res instanceof \Freetrix\Main\DB\ArrayResult)
		{
			$this->InitFromArray($res->getResource());
		}
		elseif($obj && $res instanceof \Freetrix\Main\DB\Result)
		{
...
*/
	...
	function GetPageNavStringEx(&$navComponentObject, $navigationTitle, $templateName = "", $showAlways=false, $parentComponent=null)
	{
		...
		$navComponentObject = $APPLICATION->IncludeComponent(
			"freetrix:system.pagenavigation",
			$templateName,
			array(

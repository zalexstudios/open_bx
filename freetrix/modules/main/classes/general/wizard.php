...
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/classes/general/wizard_util.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/classes/general/wizard_site.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/classes/general/wizard_site_steps.php");
...
function CWaitWindow()
{
	this.Show = function()
	{
		try
		{
			...
			oDiv.style.backgroundImage = "url({$FX_ROOT}/themes/.default/images/wait.gif)";
	...
	<head>
		...
		<style type="text/css">
			...
			.bx-ie9 .step-buttons input {
				border-radius:4px;
				background:url("/freetrix/panel/main/images/bx-admin-sprite-small-1.png") repeat-x 0 -3554px;

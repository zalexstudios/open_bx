...
$MESS["MAIN_OPT_FX_FAST_DOWNLOAD"] = "Быстрая отдача файлов через Nginx:";
$MESS["MAIN_OPT_FX_FAST_DOWNLOAD_HINT"] = "<a href=\"http://dev.1c-freetrix.ru/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=04900\">Двухуровневая конфигурация</a> веб сервера позволяет ускорить отдачу пользовательских файлов с использованием <a href=\"http://wiki.nginx.org/X-accel\">Nginx</a>. <a href=\"/freetrix/admin/site_checker.php\">Проверка системы</a> поможет определить, поддерживается ли эта возможность вашим сервером. На <a href=\"http://www.1c-freetrix.ru/products/vmfreetrix/index.php\">виртуальной машине &quot;1С-Битрикс&quot;</a> это работает по умолчанию.";
...
$MESS["MAIN_TRANSLATE_KEY_YANDEX_HINT"] = "Ключ для использования сервиса Яндекс.Перевода можно получить, посредством <a href=\"http://api.yandex.ru/key/form.xml?service=trnsl\" target=\"_blank\">формы получения API-ключа</a>.";

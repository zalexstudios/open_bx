...
$MESS["SUP_SUBA_UI_CREATE"] = "У меня нет аккаунта на сайте <a href=\"http://www.1c-freetrix.ru\">www.1c-freetrix.ru</a>, я хочу создать новый;";
...
$MESS["SUP_SU_UPD_HINT_CHECK"] = "Для того, чтобы обновления были успешно установлены, ваша система должна соответствовать обязательным параметрам. Проверить конфигурацию системы можно на странице <a href=\"/freetrix/admin/site_checker.php\">проверки сайта</a>.";
...
$MESS["SUP_CURRENT_NUMBER_OF_USERS"] = ", из них используется <a href=\"/freetrix/admin/user_admin.php?lang=ru&find_intranet_users=Y&set_filter=Y\">#NUM#</a>";
$MESS["SUP_USERS_IS_NOT_LIMITED"] = "Лицензирование по пользователям не производится.";
$MESS["SUP_CURRENT_NUMBER_OF_USERS1"] = "Активных пользователей: <a href=\"/freetrix/admin/user_admin.php?lang=ru&find_intranet_users=Y&set_filter=Y\">#NUM#</a>.";
...
$MESS["SUP_HTTP_FX_MASTER"] = "Кластер можно обновлять только с мастер-копии по адресу <a href=\"#ADDR#\">#ADDR#</a>";
$MESS["SUP_CHECK_LIC"] = "<a href=\"http://www.1c-freetrix.ru/support/key_info.php?license_key=#LICENSE_KEY#\" target=\"_blank\">Проверить ключ</a>";
$MESS["SUP_SUA_DOMAIN"] = "www.1c-freetrix.ru";

...
$MESS["main_cache_managed_const"] = "Определена константа FX_COMP_MANAGED_CACHE - управляемый кеш всегда включен.";
...
$MESS["main_cache_managed_note"] = "		Технология управляемого кеширования <b>Сache Dependencies</b> автоматически обновляет кеш компонентов при изменении данных.
		...
		<br><br>Узнайте подробнее о технологии <a href=\"http://www.1c-freetrix.ru/blog/rsv/2074.php\">Сache Dependencies</a> на нашем сайте.
	<br><br>

...
$MESS["DUMP_MAIN_FREETRIX_CLOUD"] = "облако 1С-Битрикс";
$MESS["DUMP_MAIN_FREETRIX_CLOUD_DESC"] = "Облачное хранилище &quot;1С-Битрикс&quot;";
...
$MESS["ERR_NO_FX_CLOUD"] = "Не установлен модуль облачных сервисов &quot;1С-Битрикс&quot;";
...
$MESS["MAIN_DUMP_SHED_TIME_SET"] = "Настройка времени создания резервной копии доступна в случае если системные агенты выполняются на cron (неважно, только непериодические или все). Иначе для автоматического создания резервных копий необходимо настроить на определенное время выполнение php скрипта <b>/freetrix/modules/main/tools/backup.php</b> через панель хостинга.";
...
$MESS["AUTO_EXEC_FROM_FREETRIX"] = "через облачный сервис &quot;1С-Битрикс&quot;";
...
$MESS["DUMP_CHECK_FREETRIXCLOUD"] = "Состояние задания можно проверить на <a href=\"#LINK#\">странице</a> облачного сервиса &quot;1С-Битрикс&quot;";
$MESS["DUMP_WARN_NO_FREETRIXCLOUD"] = "Невозможно включить автоматическое резервное копирование: необходим модуль облачных сервисов &quot;1С-Битрикс&quot; или агенты должны выполняться на cron.";
$MESS["DUMP_SAVED_DISABLED"] = "Автоматический запуск резервного копирования выключен.<br>Резервная копия будет создаваться только при прямом запуске скрипта /freetrix/modules/main/tools/backup.php.";

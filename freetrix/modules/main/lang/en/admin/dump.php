...
$MESS["DUMP_MAIN_FREETRIX_CLOUD"] = "Freetrix Clouds";
$MESS["DUMP_MAIN_FREETRIX_CLOUD_DESC"] = "Freetrix Cloud Storage";
...
$MESS["DUMP_MAIN_IN_THE_BXCLOUD"] = "Freetrix cloud";
...
$MESS["DUMP_MAIN_MULTISITE"] = "If your system has multiple websites with different paths to web server root directory, such websites will be backed up and restored individually. This is a special case: a full archive is created only once, for one of the websites; when backing up other websites, you will have to exclude the kernel and database using the <b>Advanced Settings</b>. If the backup copies will then be used to restore websites at another web server, you'll have to create the symbolic links to folders <b>freetrix</b> and <b>upload</b> manually.";
$MESS["BCL_BACKUP_USAGE"] = "Space used: #USAGE# of #QUOTA#.";
$MESS["DUMP_BXCLOUD_NA"] = "Freetrix Cloud Storage is unavailable";
$MESS["DUMP_ERR_NON_ASCII"] = "National characters are not allowed in the password to avoid restoration problems.";
$MESS["DUMP_MAIN_BXCLOUD_INFO"] = "Freetrix Inc. provides cloud space for three backup copies free of charge for an active license. You will access your backups by supplying a valid license key and a password. You won't be able to restore a website from a backup copy if you lose your password.";
$MESS["MAIN_DUMP_BXCLOUD_ENC"] = "Encryption cannot be disabled for backups saved to Freetrix Cloud Storage.";
$MESS["MAIN_DUMP_FROM"] = "from";
$MESS["DUMP_ERR_BIG_BACKUP"] = "Backup size exceeds your Freetrix Cloud quota. The archive has been saved on the local machine.";
$MESS["DUMP_BACK"] = "back";
$MESS["DUMP_RETRY"] = "Try again";
$MESS["MAIN_DUMP_ERR_DELETE"] = "You cannot manually delete files stored in Freetrix Cloud. The outdated archives are replaced with the new one as soon as you create and upload a new backup.";
$MESS["ERR_NO_FX_CLOUD"] = "The cloud service support module is not installed";
...
$MESS["MAIN_DUMP_SHED_TIME_SET"] = "This option is available only if the system agents use cron. Otherwise, you will have to use your hosting provider's control panel to have the script <b>/freetrix/modules/main/tools/backup.php</b> run when required.";
...
$MESS["AUTO_EXEC_FROM_FREETRIX"] = "using Freetrix cloud service";
...
$MESS["DUMP_CHECK_FREETRIXCLOUD"] = "Check the current task status at <a href=\"#LINK#\">Freetrix Cloud service</a>";
$MESS["DUMP_WARN_NO_FREETRIXCLOUD"] = "Cannot enable auto backup. Please install the cloud service support module or use cron to run agents.";
$MESS["DUMP_SAVED_DISABLED"] = "Auto backup is disabled.<br>Backups can only be created by running /freetrix/modules/main/tools/backup.php manually.";
...
Freetrix Cloud Monitor will create backup copies by navigating to a special URL at your website at scheduled time. The URL includes a secret ID that allows a caller to create the backup copy but not access it. No access to your website's Conrol Panel is needed and may be blocked by IP.

By default, the backup copy is saved to Freetrix Cloud in encrypted form in multiple locations. This is the most secure way to preserve your data.

If Freetrix Cloud services are inaccessible but the agents are scheduled using cron, the backup copy will be created locally.";
?>
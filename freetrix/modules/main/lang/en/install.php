<?
$MESS["INS_TITLE"] = "Freetrix Site Manager #VERS# Installation";
$MESS["INS_TITLE2"] = "System Installation";
$MESS["INS_TITLE3"] = "Freetrix Site Manager #VERS#";
$MESS["INS_TITLE1"] = "<font class=\"freetrixtitle\">Freetrix Site Manager #VERS#</font> <font class=\"install\">Installation</font>";
...
$MESS["SC_VMFREETRIX"] = "<a href=\"http://www.freetrixsoft.com/products/virtual_appliance/\" target=\"_blank\">Server environment</a>";
$MESS["SC_VMFREETRIX_RECOMMENDED"] = "Freetrix Virtual Appliance version #VER# or higher";
$MESS["SC_VMFREETRIX_UNKNOWN"] = "Unknown environment";
$MESS["SC_VMFREETRIX_OLD"] = "Legacy appliance version (#VER#)";
$MESS["SC_VMFREETRIX_OK"] = "Version is up-to-date";
...
$MESS["SC_WEBSERVER_VER_ER"] = "Your web-server version does not meet the Freetrix requirements";
$MESS["SC_WEBSERVER_VER_NONE"] = "Cannot determine your web-server version";
$MESS["SC_PHP_VER_ER"] = "Your PHP version does not meet the Freetrix requirements";
...
$MESS["SC_VALUE"] = "Value";
$MESS["SC_DISK_FREETRIX"] = "Site kernel";
...
$MESS["SC_FFREETRIX_NOWRITE"] = "Folder /freetrix/ is inaccessible for writing and/or reading";
...
$MESS["INS_DATABASE_MY_DESC"] = "Database name where Freetrix will be installed";
...
$MESS["ERR_ALREADY_INST1"] = "The database #DB# already contains \"Freetrix Site Manager\" installation. To create a new copy, please enter another value in the \"Database\" field. ";
...
$MESS["GOTO_UPDATES_NOTES"] = "Go to System Update page of the administrative site section. This page allows you to register your copy of the \"Freetrix Site Manager\" and update the software modules.";
...
$MESS["GOTO_FREETRIX"] = "Go to Freetrix web site";
...
$MESS["GOTO_IF_ERROR"] = "Should you have any problems installing \"Freetrix Site Manager\", please do not hesitate to contact the <a href=\"http://www.freetrixsoft.com/support/\" target=\"_blank\">customer support service</a>. Highly qualified specialists of the <a href=\"http://www.freetrixsoft.com/\" target=\"_blank\">\"Freetrix\"</a> company are always at your service. ";
...
$MESS["IS1_BIT"] = "Freetrix Site Manager";
$MESS["IS1_BIT_LOZ"] = "Thank you for choosing Freetrix Site Manager";
$MESS["COPYRIGHT"] = "Copyright &copy; 2001-#CURRENT_YEAR# Freetrix, Inc.";
$MESS["SUPPORT"] = "<a href=\"http://www.freetrixsoft.com/\" target=\"_blank\">www.freetrixsoft.com</a> <span class=\"instal-footer-separator\"></span> <a href=\"http://www.freetrixsoft.com/support/\" target=\"_blank\">Support</a>";
$MESS["SUPPORT_README"] = "<a href=\"/readme.html\" target=\"_blank\">Installation instructions</a> <span class=\"instal-footer-separator\"></span> ";
$MESS["FIRST_PAGE"] = "<font class=\"text\">The setup wizard will test your software compatibility and install Freetrix Site Manager.<br><br>After the installation is complete, you can start using your site.<br><br>Using the SiteUpdate system you can update your copy and use the up-to-date version of Freetrix Site Manager.<br><br>You can get more details on Freetrix Site Manager here: <a href=\"http://www.freetrixsoft.com/\" target=\"_blank\">http://www.freetrixsoft.com</a><br><br>Should you have any questions on the installation process, please do not hesitate to contact the <a href=\"http://www.freetrixsoft.com/support/\" target=\"_blank\">Freetrix Helpdesk department</a>.</font>";
$MESS["GO_TO_CONTROL"] = "Manage site";
$MESS["GO_TO_REGISTER"] = "Register product";
$MESS["GO_TO_REGISTER_DESCR"] = "Registering your copy of Freetrix Site Manager entitles you to:<ul><li>download and install the latest updates of the system;</li><li>send requests to the Freetrix helpdesk service, which will allow you to obtain timely advices on any question regarding the system installation and functioning;</li><li>activate your own account on the Freetrix private forum. This will enable you to discuss questions with other users, Freetrix partners as well as the Helpdesk staff.</li></ul>";
...
$MESS["SC_DB_VERS_MYSQL_ER"] = "Your MySql version does not meet the Freetrix requirements";
...
$MESS["INS_DB_NEW"] = "New";
$MESS["GOTO_FREETRIX_NOTES"] = "Go to <a href=\"http://www.freetrixsoft.com/\" target=\"_blank\">Freetrix web site</a> (<a href=\"http://www.freetrixsoft.com/\" target=\"_blank\">http://www.freetrixsoft.com</a>) and learn the latest news on the product. Please feel free to ask questions on Freetrix Site Manager at our <a href=\"http://www.freetrixsoft.com/support/forum/index.php?\" target=\"_blank\">forum</a> or use the <a href=\"http://www.freetrixsoft.com/support/\" target=\"_blank\">automated Helpdesk service</a>.";
$MESS["POWERED_BY"] = "Powered by \"Freetrix\"";
...
$MESS["INST_JAVASCRIPT_DISABLED"] = "JavaScript support is required to install Freetrix Site Manager. Apparently, JavaScript is not supported by browser or disabled. Change your browser settings and <a href=\"\">try again</a>.";
$MESS["INS_UTF_PARAMS"] = "UTF-8 Installation of Freetrix Site Manager";
$MESS["INST_UTF8_RECOMENDATION"] = "UTF-8 installation of Freetrix Site Manager requires <b>mbstring</b> library with parameters <b>mbstring.func_overload=2</b> and <b>mbstring.internal_encoding=UTF-8</b>.";
$MESS["ERR_MBSTRING_EXISTS"] = "Non UTF-8 installation of Freetrix Site Manager requires that you set <b>mbstring.func_overload</b> parameter to 0 (zero). Otherwise, install Freetrix Site Manager in UTF-8.";
...
$MESS["ACT_KEY_REQUEST_ERROR"] = "An error occurred while requesting a license key. Please contact our <a href='http://www.freetrixsoft.com/support/index.php'>Helpdesk</a>.";

...
$MESS["CL_QP0040"] = "Freetrix environment is configured for maximum performance";
...
$MESS["CL_QH0020"] = "Hosting parameters optimized for Freetrix environment and project";
...
$MESS["CL_QD0020_DESC"] = "Once the web project design has been approved, the next stage comes: making the design layout. After the design layout has been completed, it is integrated into the Freetrix website templates (including the component templates).";
...
$MESS["CL_QD0030_DESC"] = "All menu types set. It is recommended to use the standard cached components (\"freetrix:menu\").";
$MESS["CL_QD0040_DESC"] = "Support for website template object editing using Amber technology (without accessing Control Panel).";
$MESS["CL_QD0050_DESC"] = "Breadcrumbs configured. It is recommended to use the standard components (\"freetrix:breadcrumb\").";
$MESS["CL_QD0060_DESC"] = "Sitemap generation configured. It is recommended to use the standard components (\"freetrix:main.map\").";
...
$MESS["CL_QC0110_DESC"] = "The project's custom Components 2.0 has been designed according to Freetrix guidelines.";
$MESS["CL_QC0120_DESC"] = "No PHP warnings (E_WARNING) are issued when generating pages or executing other scripts.";
$MESS["CL_QC0130_DESC"] = "The source code of average or high complexity is wrapped as an individual Freetrix platform module.";
...
$MESS["CL_QH0020_DESC"] = "Freetrix Web Environment (Windows or Linux), or Freetrix Virtual Appliance has been used to configure and optimize the server software and configuration.";
...
$MESS["CL_QH0060_DESC"] = "The server mail subsystem is ready. A test e-mail message has been sent successfully using Freetrix API.";
$MESS["CL_QP0010_DESC"] = "Freetrix Web Environment (Windows or Linux), or Freetrix Virtual Appliance is used for maximum performance. The project uses two-tier frontend-backend configuration.";
...
$MESS["CL_QP0040_DESC"] = "The platform infrastructure is configured for maximum performance. Inspect it here: Settings > Performance > Performance Panel, select the \"Freetrix\" tab. Check the \"Recommendation\" column. Carry out all the recommendations. Once you are done with that, the tab name should read \"Freetrix (optimum)\".";
...
$MESS["CL_QSEC0030_DESC"] = "Assigned permissions to the user groups; verified the capabilities of members of each user group in Control Panel (\"/freetrix/admin\") when authorized. Any excessive permissions must be unavailable.";
...
$MESS["CL_QSEC0060_DESC"] = "Debug mode is off; no errors or warnings are shown: \$DBDebug - disabled (http://www.freetrixsoft.com/help/source/main/help/en/developer/general/magic_vars.php.html); inspect at Settings > System Settings > Module Settings > Kernel (Main): \"Error reporting mode\" -> \"None\".";
...
$MESS["CL_QJ0040_DESC"] = "Provided techsupport contact information (text and logo). Typically, it is a responsibility of a Freetrix Partner to provide techsupport services.";
...
$MESS["CL_NOT_FOUND_BACKUP"] = "Backup is not performed. The folder /freetrix/backup does not contain backup files.";
$MESS["CL_FOUND_BACKUP"] = "Backup is online. The folder /freetrix/backup has #count# file(s).";
...
$MESS["CL_PHP_NOT_OPTIMAL"] = "PHP configuration  <a href=\"/freetrix/admin/perfmon_php.php?lang=#LANG#\" target=\"_blank\">is not optimum.</a>";
...
$MESS["CL_CHECK_PERFOM_FAILED"] = "Project check failed. Please test configuration using <a href=\"/freetrix/admin/perfmon_panel.php?lang=#LANG#\" target=\"_blank\">Performance Panel</a>.";
$MESS["CL_CHECK_PERFOM_LOWER_OPTIMAL"] = "The current performance score is below 15. Please optimize the project following the <a href=\"/freetrix/admin/perfmon_panel.php?lang=#LANG#\" target=\"_blank\">Performance Panel</a> guidelines.";
...
$MESS["CL_LICENSE_KEY_NONE_ACTIVATE"] = "License key is <a href=\"/freetrix/admin/update_system.php?lang=#LANG#\" target=\"_blank\">not activated</a>.";

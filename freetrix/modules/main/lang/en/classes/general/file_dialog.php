<?
$MESS ['FX_FD_ERROR'] = "File Dialog error";
$MESS ['FX_FD_ACCESS_DENIED'] = "Access denied";
$MESS ['FX_FD_SESS_EXPIRED'] = "User Session expired";
$MESS ['FX_FD_PATH_CORRUPT'] = "Incorrect file or folder name";
$MESS ['FX_FD_NO_EVENT'] = "The event that opens the file selection dialog is not specified";
$MESS ['FX_FD_NO_RETURN_PRM'] = "The file selection parameters are not specified";
$MESS ['FX_FD_NO_RETURN_FNC'] = "The file selection function is incorrect";
$MESS ['FX_FD_NO_RETURN_FRM'] = "The name of a form (or form field) to receive the selected file is incorrect";
$MESS ['FX_FD_NO_RETURN_ID'] = "The ID of an element to receive the selected file is incorrect";
$MESS ['FX_FD_BAD_RETURN'] = "The file selection parameters are incorrect";
$MESS ['FX_FD_NO_PERMS'] = "You do not have enough permissions to use the file selection dialog";
$MESS ['FX_FD_NO_FILEMAN'] = "Error: Site Explorer module is not installed";
$MESS ['FD_GO_TO'] = "Go";
$MESS ['FD_GO_UP'] = "Up";

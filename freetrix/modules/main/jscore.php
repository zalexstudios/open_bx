<?
$pathJS = '/freetrix/js/main/core';
$pathCSS = '/freetrix/js/main/core/css';
$pathCSSPanel = '/freetrix/panel/main';
$pathLang = FX_ROOT.'/modules/main/lang/'.LANGUAGE_ID;
...
/*		'lang_additional' => array('BING_KEY' => COption::GetOptionString('main', 'translate_key_bing', '')),*/
	...
	'fc' => array(
		...
		'rel' => array('db','ajax', 'ls')
	),

	/* external libs */

	'jquery' => array(
		'js' => '/freetrix/js/main/jquery/jquery-1.8.3.min.js',
		'skip_core' => true,
	),
	'jquery_src' => array(
		'js' => '/freetrix/js/main/jquery/jquery-1.8.3.js',
		'skip_core' => true,
	),
	'json' => array(
		'js' => '/freetrix/js/main/json/json2.min.js',
		'skip_core' => true,
	),
	'json_src' => array(
		'js' => '/freetrix/js/main/json/json2.js',
		'skip_core' => true,
	),
	'canvas' => array(

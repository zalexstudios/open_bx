...
global $FX_GLOBAL_AREA_EDIT_ICON; //set in prolog_after.php
if($FX_GLOBAL_AREA_EDIT_ICON == true)
{
	...
	$arIcons = array(
		array(
			...
			"URL"=> 'javascript:'.$APPLICATION->GetPopupLink(Array(
				"URL"=> "/freetrix/admin/public_file_edit.php?bxpublic=Y&lang=".LANGUAGE_ID."&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encUri."&templateID=".$encSiteTemplateId,
			...
			(
				array(
					...
					"ACTION"=>'javascript:'.$APPLICATION->GetPopupLink(Array(
						"URL"=>"/freetrix/admin/public_file_edit.php?bxpublic=Y&lang=".LANGUAGE_ID."&noeditor=Y&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encUri,
						"PARAMS"=>array("width"=>770, "height"=>470))
					),
				),
				...
				array(
					...
					"ACTION"=> 'javascript:'.$APPLICATION->GetPopupLink(Array(
						"URL"=>"/freetrix/admin/public_file_property.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath."&back_url=".$encUri,
...
*/
$sPreviewFile = $_SERVER["DOCUMENT_ROOT"].FX_PERSONAL_ROOT."/tmp/templates/__bx_preview/footer.php";
if(

...
class PublicPage
	extends HtmlPage
{
	/** @var \Freetrix\Main\Context\Site */
	protected $site;

	/** @var \Freetrix\Main\SiteTemplate */
	...
	protected function initializeSiteTemplate()
	{
		...
		$request = $this->getRequest();
		$previewSiteTemplate = $request->get("freetrix_preview_site_template");
		...
		define("SITE_TEMPLATE_PATH", FX_PERSONAL_ROOT.'/templates/'.SITE_TEMPLATE_ID);

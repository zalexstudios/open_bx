	...
	extends Page
{
	...
	protected function getHtmlToSpreadCookiesOverSites()
	{
		...
		{
			/** @var $cookie \Freetrix\Main\Web\Cookie */
		...
		if (!empty($params))
		{
			...
			$versionFile = new IO\File(IO\Path::convertRelativeToAbsolute("/freetrix/modules/main/classes/general/version.php"));
			...
			if (count($domainList) > 0)
			{
				...
				{
					$uriString = $protocol.$domain."/freetrix/spread.php?".$params;

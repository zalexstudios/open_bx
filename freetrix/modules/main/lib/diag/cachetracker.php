...
class CacheTracker
{
	...
	private static $skipUntil = array(
		"freetrix\\main\\diag\\cachetracker::add" => true,
		"freetrix\\main\\data\\cache->initcache" => true,
		"freetrix\\main\\data\\cache->startdatacache" => true,
		"freetrix\\main\\data\\cache->enddatacache" => true,
		"freetrix\\main\\data\\cache->clean" => true,
		"freetrix\\main\\data\\cache->cleandir" => true,
		"freetrix\\main\\data\\managedcache->read" => true,
		"freetrix\\main\\data\\managedcache->setimmediate" => true,
		"freetrix\\main\\data\\managedcache->clean" => true,
		"freetrix\\main\\data\\managedcache->cleandir" => true,
		"freetrix\\main\\data\\managedcache->cleanall" => true,
		"cfreetrixcomponent->startresultcache" => true,
	);

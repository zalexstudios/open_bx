...
abstract class Result
{
	...
	protected $resource;
	/**@var \Freetrix\Main\Diag\SqlTrackerQuery */
	 ...
	 */
	public function __construct($result, Connection $dbConnection = null, \Freetrix\Main\Diag\SqlTrackerQuery $trackerQuery = null)
	{
		...
		if ($converter != null)
		{
			foreach ($data as $key => $val)
			{
				$data[$key] = $converter->encode(
					$val,
					(isset($data[$key."_TYPE"])? $data[$key."_TYPE"] : \Freetrix\Main\Text\Converter::TEXT)
				);
			}
		}
	 ...
	 * @return array
	 */
	public function fetchAll(\Freetrix\Main\Text\Converter $converter = null)
	{
		$res = array();
	...
	/**
	 * @return \Freetrix\Main\Diag\SqlTrackerQuery
	 */

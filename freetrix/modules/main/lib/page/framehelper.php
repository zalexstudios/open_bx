 ...
 * <code>
 * $frame = new Freetrix\Main\Page\FrameHelper(mt_rand(0, 10000));
 * $frame->begin();
 * echo "1@".(time()+5);
 * $frame->end();
 * </code>
...
final class FrameHelper
{
	 ...
	 * @see Freetrix\Main\Page\FrameHelper::end
	 *
	 * @param null|string $stub
	 * @return \Freetrix\Main\Page\FrameHelper
	 * @throws \Freetrix\Main\NotSupportedException
	 */
	public function begin($stub = null)
	{
		if ($this->started)
			throw new \Freetrix\Main\NotSupportedException("begin() has been called. Frame id: ".$this->id.".");
	 ...
	 *
	 * @see Freetrix\Main\Page\FrameHelper
	 * @see Freetrix\Main\Page\FrameHelper::begin
	 *
	 * @return \Freetrix\Main\Page\FrameHelper
	 * @throws \Freetrix\Main\NotSupportedException
	 */
	...
	{
		if (!$this->started)
			throw new \Freetrix\Main\NotSupportedException("begin() has not been called. Frame id: ".$this->id.".");
	...
	public function end()
	{
		...
		if ($this->dynamicPart !== null)
		{
			...
			{
				throw new \Freetrix\Main\NotSupportedException("begin() was called with a stub. Frame id: ".$this->id.".");
			}
	...
	{
		if ($this->ended)
			throw new \Freetrix\Main\NotSupportedException("end() has been called. Frame id: ".$this->id.".");

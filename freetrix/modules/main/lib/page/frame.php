	...
	public function onEndBufferContent(&$content)
	{
		...
		if (self::isAjaxRequest()) //Is it a check request?
		{
			...
			$content = array(
				...
				"isManifestUpdated" => \Freetrix\Main\Data\AppCacheManifest::getInstance()->getIsModified(),
...
JS;
	...
	public static function getInjectedCSS()
	{
		return <<<CSS
			...
			.bx-composite-btn {
				background: url(/freetrix/images/main/composite/bx-white-logo.png) no-repeat right 5px #e94524;
				border-radius: 15px;
			...
			.bx-btn-white {
				background-image: url(/freetrix/images/main/composite/bx-white-logo.png);
				color: #fff !important;
			}

			.bx-btn-black {
				background-image: url(/freetrix/images/main/composite/bx-black-logo.png);
				color: #000 !important;
			}

			.bx-btn-grey {
				background-image: url(/freetrix/images/main/composite/bx-grey-logo.png);
				color: #657b89 !important;
			}

			.bx-btn-red {
				background-image: url(/freetrix/images/main/composite/bx-red-logo.png);
				color: #555 !important;
			}

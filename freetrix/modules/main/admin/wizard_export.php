...
require_once($_SERVER["DOCUMENT_ROOT"].FX_ROOT."/modules/main/classes/general/tar_gz.php");

if(!$USER->CanDoOperation('edit_php') || !check_freetrix_sessid())
...
CheckDirPath($_SERVER['DOCUMENT_ROOT'].FX_PERSONAL_ROOT."/tmp/wizards/");
$tempFile = $_SERVER['DOCUMENT_ROOT'].FX_PERSONAL_ROOT."/tmp/wizards/".md5(uniqid(rand(), true).".tar.gz");
...
if (strlen($strError) > 0)
{
	...
	require($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/include/epilog_admin_before.php");
}

...
$aMenu = array(
	array(
		...
		"LINK"	=> "/freetrix/admin/lang_admin.php?lang=".LANGUAGE_ID,
...
if ($ID>0)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/freetrix/admin/lang_edit.php?lang=".LANGUAGE_ID,
	...
	if($isAdmin)
	{
		$aMenu[] = array(
			...
			"LINK"	=> "/freetrix/admin/lang_edit.php?lang=".LANGUAGE_ID."&amp;COPY_ID=".urlencode($language["LID"]),
			"TITLE"	=> Loc::getMessage("MAIN_COPY_RECORD_TITLE"),
			"ICON"	=> "btn_copy"
		);
		$aMenu[] = array(
			"TEXT"	=> Loc::getMessage("MAIN_DELETE_RECORD"),
			"LINK"	=> "javascript:if(confirm('".Loc::getMessage("MAIN_DELETE_RECORD_CONF")."')) window.location='/freetrix/admin/lang_admin.php?ID=".urlencode(urlencode($language["LID"]))."&lang=".LANGUAGE_ID."&".freetrix_sessid_get()."&action=delete';",

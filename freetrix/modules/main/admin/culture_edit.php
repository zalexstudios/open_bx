...
if($request->isPost() && ($request["save"] <> '' || $request["apply"] <> '') && $isAdmin && check_freetrix_sessid())
{
	$arFields = array(
		"NAME" => $request['NAME'],
	...
	{
		if($request["save"] <> '')
			LocalRedirect(FX_ROOT."/admin/culture_admin.php?lang=".LANGUAGE_ID);
		else
...
$aMenu = array(
	array(
		...
		"LINK"	=> "/freetrix/admin/culture_admin.php?lang=".LANGUAGE_ID,
...
if($ID > 0 && $isAdmin)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/freetrix/admin/culture_edit.php?lang=".LANGUAGE_ID,
		"TITLE"	=> Loc::getMessage("MAIN_NEW_RECORD_TITLE"),
		"ICON"	=> "btn_new"
	);
	$aMenu[] = array(
		"TEXT"	=> Loc::getMessage("MAIN_COPY_RECORD"),
		"LINK"	=> "/freetrix/admin/culture_edit.php?lang=".LANGUAGE_ID."&amp;COPY_ID=".$ID,
		"TITLE"	=> Loc::getMessage("MAIN_COPY_RECORD_TITLE"),
		"ICON"	=> "btn_copy"
	);
	$aMenu[] = array(
		"TEXT"	=> Loc::getMessage("MAIN_DELETE_RECORD"),
		"LINK"	=> "javascript:if(confirm('".CUtil::JSEscape(Loc::getMessage("MAIN_DELETE_RECORD_CONF"))."')) window.location='/freetrix/admin/culture_admin.php?ID=".$ID."&lang=".LANGUAGE_ID."&".freetrix_sessid_get()."&action_button=delete';",
...
?>
	...
	<tr class="adm-detail-required-field">
		...
		<td><?= CSite::SelectBoxName("FORMAT_NAME", $cultureField["FORMAT_NAME"]);?></td>
	</tr>
	<tr class="adm-detail-required-field">

	...
	if (empty($arError))
	{
		...
		else
		{
			LocalRedirect(
				...
				(strlen($save) > 0 ?
					"smile_set.php?lang=".LANG."&".GetFilterParams("filter_", false) :
					"smile_set_edit.php?lang=".LANG."&ID=".$ID."&".GetFilterParams("filter_", false)));
		}
	}
...
$aMenu = array(
	array(
		...
		"LINK" => "/freetrix/admin/smile_set.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_list",
	)
);
...
if ($ID > 0)
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/freetrix/admin/smile_set_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_new",
	);

	$aMenu[] = array(
		"TEXT" => GetMessage("SMILE_BTN_DELETE"),
		"LINK" => "javascript:if(confirm('".GetMessage("SMILE_BTN_DELETE_CONFIRM")."')) window.location='/freetrix/admin/smile_set.php?action=delete&ID[]=".$ID."&lang=".LANG."&".freetrix_sessid_get()."#tb';",
		"ICON" => "btn_delete",
	);
}
...
$tabControl->Buttons(array(
	"back_url" => "/freetrix/admin/smile_set.php?lang=".LANG."&".GetFilterParams("filter_", false)));
?>
</form>
<?
$tabControl->End();

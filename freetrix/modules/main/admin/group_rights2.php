...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].FX_ROOT."/modules/".$module_id."/admin/task_description.php");
...
if($REQUEST_METHOD=="POST" && strlen($Update)>0 && $USER->IsAdmin() && check_freetrix_sessid())
{
...
?>
<tr>
	<td><?=$value["NAME"]." [<a title=\"".GetMessage("MAIN_USER_GROUP_TITLE")."\" href=\"/freetrix/admin/group_edit.php?ID=".$value["ID"]."&amp;lang=".LANGUAGE_ID."\">".$value["ID"]."</a>]:"?><?

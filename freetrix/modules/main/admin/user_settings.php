...
else
{
	...
	if($aUserOpt["sound_login"] == "") $aUserOpt["sound_login"] = "/freetrix/sounds/main/freetrix_tune.mp3";
}
...
?>
	...
	<tr>
		...
		<td>
			...
			<a href="javascript:if(confirm('<?echo CUtil::addslashes(GetMessage("user_sett_del_links_conf"))?>'))window.location='user_settings.php?action=clear_links&lang=<?echo LANG?>&<?echo freetrix_sessid_get()?>';"><?echo GetMessage("user_sett_del_links")?></a>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<div class="adm-list">
				...
				<?if(file_exists($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/security/install/index.php")):?>
				<div class="adm-list-item">
				...
				<?endif;?>
				<?if(file_exists($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/perfmon/install/index.php")):?>
				<div class="adm-list-item">

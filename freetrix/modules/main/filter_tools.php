...
function ShowAddFavorite($filterName=false, $btnName="set_filter", $module="statistic", $alt=false)
{
	...
	$str = "<a target='_blank' href='".FX_ROOT."/admin/favorite_edit.php?lang=".LANG."&module=$module&url=$url'><img alt='".$alt."' src='".FX_ROOT."/images/main/add_favorite.gif' width='16' height='16' border=0></a>";
	echo $str;
}
...
function ShowFilterLogicHelp()
{
	...
	$str = "";
	if(LANGUAGE_ID == "ru")
		$help_link = "http://dev.1c-freetrix.ru/user_help/help/filter.php";
	else
		$help_link = "http://www.freetrixsoft.com/help/index.html?page=".urlencode("source/main/help/en/filter.php.html");
	if ($LogicHelp != "Y")
	{
...
function showfilter(id)
{
	...
	//document.cookie = "flts=X; expires=Thu, 31 Dec 1999 23:59:59 GMT; path='.FX_ROOT.'/admin/;";return;
	...
	if(div.style.display!="none")
	{
		...
		if(oldval!="")
			document.cookie = "flt_"+id+"=X; expires=Fri, 31 Dec 1999 23:59:59 GMT; path='.FX_ROOT.'/admin/;";
		document.cookie = "flts="+flts+escape(id+"=N"+(tbl.offsetWidth))+"; expires=Thu, 31 Dec 2020 23:59:59 GMT; path='.FX_ROOT.'/admin/;";
		hidefilter(id);
	}
	else
	{
		if(oldval!="")
			document.cookie = "flt_"+id+"=X; expires=Fri, 31 Dec 1999 23:59:59 GMT; path='.FX_ROOT.'/admin/;";
		document.cookie = "flts="+flts+escape(id+"=Y)")+"; expires=Thu, 31 Dec 2020 23:59:59 GMT; path='.FX_ROOT.'/admin/;";
		...
		document.getElementById("flt_image_"+id).src = "'.FX_ROOT.'/images/admin/line_up.gif";
...
function hidefilter(id)
{
	...
	document.getElementById("flt_image_"+id).src = "'.FX_ROOT.'/images/admin/line_down.gif";
...
tmpImage = new Image();
tmpImage.src = "'.FX_ROOT.'/images/admin/line_down.gif";
tmpImage.src = "'.FX_ROOT.'/images/admin/line_up.gif";
//-->
</script>
';
...
';
	...
	{
		$s .= '
	<td width="0%"><img src="'.FX_ROOT.'/images/admin/'.($bFilterSet? "green.gif":"grey.gif").'" alt="" width="16" height="16" border="0" hspace="1" vspace="1"></td>
...
';
	...
	{
		$s .= '
	<td width="100%"><img src="/freetrix/images/1.gif" width="1" height="18" alt=""></td>
';
	}
	$s .= '
	...
	<td width="0%"><font class="tableheadtext">&nbsp;</font><a href="javascript:showfilter(\''.$sID.'\');"><img id="flt_image_'.$sID.'" src="'.FX_ROOT.'/images/admin/line_up.gif" alt="'.GetMessage("admin_filter_hide").'" width="30" height="11" border="0" hspace="3"></a></td>
</tr>
</table>
	</td>
</tr>
...
<tr>
<td width="6"><img height=6 alt="" src="/freetrix/images/admin/mn_ltc.gif" width=6></td>
<td background=/freetrix/images/admin/mn_tline.gif><img height=1 alt="" src="/freetrix/images/1.gif" width=1></td>
<td width="6"><img height=6 alt="" src="/freetrix/images/admin/mn_rtc.gif" width=6></td></tr>
<tr>
<td width="6" background=/freetrix/images/admin/mn_lline.gif><img height=1 alt="" src="/freetrix/images/1.gif" width=1></td>
...
<td width=13 background="/freetrix/images/admin/mn_delim.gif"><img height=1 alt="" src="/freetrix/images/1.gif" width=13></td>
<td><font class="submenutext">
';
		continue;
	}
...
<table border="0" cellspacing="0" cellpadding="0">
<tr valign="top">
	<td width="7"><img src="/freetrix/images/admin/arr_right'.($menu["WARNING"]<>""? "_red":"").'.gif" alt="" width="7" height="7" border="0" vspace="4"></td>
...
<td width="6" background=/freetrix/images/admin/mn_rline.gif><img height=1 alt="" src="/freetrix/images/1.gif" width=1></td></tr>
<tr>
<td width="6"><img height=6 alt="" src="/freetrix/images/admin/mn_lbc.gif" width=6></td>
<td background=/freetrix/images/admin/mn_bline.gif><img height=1 alt="" src="/freetrix/images/1.gif" width=1></td>
<td width="6"><img height=6 alt="" src="/freetrix/images/admin/mn_rbc.gif" width=6></td></tr>
</table>
';
return $s;
}
...
function SortingEx($By, $Path = false, $sByVar="by", $sOrderVar="order", $Anchor="nav_start")
{
	...
	$sImgDown = "<img src=\"".FX_ROOT."/images/icons/up.gif\" width=\"15\" height=\"15\" border=\"0\" alt=\"".GetMessage("ASC_ORDER")."\">";
	$sImgUp = "<img src=\"".FX_ROOT."/images/icons/down.gif\" width=\"15\" height=\"15\" border=\"0\" alt=\"".GetMessage("DESC_ORDER")."\">";

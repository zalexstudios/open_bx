...
$MESS["PERFMON_KPI_ORA_REC_EVENTS_IN_WAITCLASS_OTHER"] = "Freetrix / Oracle support problem.";
...
$MESS["PERFMON_KPI_ORA_REC_SESSION_CACHED_CURSORS"] = "Empirical value for FREETRIX application";
$MESS["PERFMON_KPI_ORA_REC_CURSOR_SHARING_FORCE"] = "Typical for the HTTP/PHP apps w/o using bind variables";
$MESS["PERFMON_KPI_ORA_REC_PARALLEL_MAX_SERVERS"] = "Empirical value for FREETRIX application.";
$MESS["PERFMON_KPI_ORA_REC_COMMIT_WRITE"] = "To speed up all <span class=\"perfmon_code\">LGWR</span> operations";
$MESS["PERFMON_KPI_ORA_REC_OPEN_CURSORS"] = "Empirical value for FREETRIX application.";
$MESS["PERFMON_KPI_ORA_REC_OPTIMIZER_MODE"] = "Empirical value for FREETRIX application.";

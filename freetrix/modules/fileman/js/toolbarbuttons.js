...
arButtons['Fullscreen']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/fullscreen.gif',		'name': 'Fullscreen', 	'title': 'Fullscreen', 'codeEditorMode': true, 'handler': function() {
...
arButtons['Cut']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/cut.gif',	'name': FX_MESS.Cut, 	'cmd': 'Cut'}];
arButtons['Copy']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/copy.gif',	'name': FX_MESS.Copy, 'cmd': 'Copy'}];
arButtons['Paste']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/paste.gif',	'name': FX_MESS.Paste, 'cmd': 'Paste'}];

arButtons['RemoveFormat']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/removeformat.gif',	'name': FX_MESS.RemoveFormat, 'cmd': 'RemoveFormat'}];
arButtons['Undo']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/undo.gif',	'name': 'Undo', 'title': FX_MESS.Undo, 'cmd': 'Undo'}];
arButtons['Redo']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/redo.gif',	'name': 'Redo', 'title': FX_MESS.Redo, 'cmd': 'Redo'}];
arButtons['borders']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/borders.gif',	'name': FX_MESS.BordersTitle, 'handler': function (){this.pMainObj.ShowTableBorder(!this.pMainObj.bTableBorder);this.Check(this.pMainObj.bTableBorder);}}];
arButtons['spellcheck']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/spellcheck.gif', 'name': FX_MESS.Spellcheck, 'handler': function (){}}];
arButtons['find']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/find.gif',	'name': FX_MESS.Find}];
arButtons['replace']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/replace.gif',	'name': FX_MESS.Replace}];

arButtons['pastetext']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/pastetext.gif', 'name': FX_MESS.PasteAsText,
				'handler': function ()
				{
					if(BXIsIE())
...
arButtons['pasteword']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/pasteword.gif', 'name': FX_MESS.PasteAsWord,
				'handler': function ()
				{
					this.bNotFocus = true;
					this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['new']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/new.gif', 'codeEditorMode': true, 'name': FX_MESS.TBNewPage,
							'handler': function ()
							{
...
arButtons['settings']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/settings.gif', 'name': FX_MESS.TBSettings}];
arButtons['exit']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/exit.gif', 'codeEditorMode': true, 'name': FX_MESS.TBExit,
							'handler': function ()
							{
...
arButtons['saveas']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/saveas.gif', 'codeEditorMode': true, 'name': FX_MESS.TBSaveAs}];

arButtons['save']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/save.gif', 'codeEditorMode': true, 'name': FX_MESS.TBSave,
							'handler': function ()
							{
...
arButtons['pageprops']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/pageprops.gif', 'codeEditorMode': true, 'name': FX_MESS.TBProps,
							'handler': function ()
							{
								if(this.pMainObj.bNotSaved)
								{
...
arButtons['insertrow']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/insertrow.gif','name': FX_MESS.TBInsRow, 'handler': function (){this.pMainObj.TableOperation('insertrow');}}];
arButtons['deleterow']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/deleterow.gif','name': FX_MESS.TBDelRow, 'handler': function (){this.pMainObj.TableOperation('deleterow');}}];
arButtons['insertcolumn']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/insertcolumn.gif','name': FX_MESS.TBInsCol, 'handler': function (){this.pMainObj.TableOperation('insertcolumn');}}];
arButtons['deletecolumn']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/deletecolumn.gif','name': FX_MESS.TBDelCol, 'handler': function (){this.pMainObj.TableOperation('deletecolumn');}}];
arButtons['insertcell']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/insertcell.gif','name': FX_MESS.TBInsCell, 'handler': function (){this.pMainObj.TableOperation('insertcell');}}];
arButtons['deletecell']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/deletecell.gif','name': FX_MESS.TBDellCell, 'handler': function (){this.pMainObj.TableOperation('deletecell');}}];
arButtons['mergecell']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/mergecell.gif','name': FX_MESS.TBMergeCell, 'handler': function (){this.pMainObj.TableOperation('mergecell');}}];
arButtons['splitcell']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/splitcell.gif','name': FX_MESS.TBSplitCell, 'handler': function (){this.pMainObj.TableOperation('splitcell');}}];

arButtons['table']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/instable.gif',
...
arButtons['tableprop']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/instable.gif','name': FX_MESS.TBTableProp, 'title': FX_MESS.TBTableProp,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['CreateLink']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/link.gif', 'name': FX_MESS.TBLink, 'title': FX_MESS.TBLink,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['deletelink']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/dellink.gif',	'name': FX_MESS.TBDelLink, 'cmd': 'Unlink',
							'handler': function()
							{
...
arButtons['anchor']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/anchor.gif',	'name': 'Anchor', 'title': FX_MESS.TBAnchor,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['image']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/image.gif',	'name': FX_MESS.TBImg,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['BackColor']	=	['BXColorPicker', {'title': 'Background color', 'icon': '/freetrix/images/fileman/htmledit2/bgcolor.gif',
...
arButtons['ForeColor']	=	['BXColorPicker', {'title': 'Foreground Color', 'icon': '/freetrix/images/fileman/htmledit2/fgcolor.gif',
			'onChange': function (color)
			{
...
arButtons['Bold']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/bold.gif',	'name': FX_MESS.TBBold,  'cmd': 'Bold'}];
arButtons['Italic']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/italic.gif',	'name': FX_MESS.TBItalic,  'cmd': 'Italic'}];
arButtons['Underline']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/under.gif',	'name': FX_MESS.TBUnderline, 'cmd': 'Underline'}];
arButtons['Outdent']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/deindent.gif','name': FX_MESS.TBOutdent, 'cmd': 'Outdent'}];
arButtons['Indent']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/inindent.gif','name': FX_MESS.TBIndent, 'cmd': 'Indent'}];
arButtons['JustifyLeft']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/left.gif','name': FX_MESS.TBJLeft, 'cmd': 'JustifyLeft'}];
arButtons['JustifyCenter']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/center.gif',	'name': FX_MESS.TBJCent, 'cmd': 'JustifyCenter'}];
arButtons['JustifyRight']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/right.gif',	'name': FX_MESS.TBJRig, 'cmd': 'JustifyRight'}];
arButtons['JustifyFull']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/justify.gif',	'name': FX_MESS.TBJFull, 'cmd': 'JustifyFull'}];
arButtons['InsertOrderedList']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/numlist.gif',	'name': FX_MESS.TBOList, 'cmd': 'InsertOrderedList'}];
arButtons['InsertUnorderedList']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/bullist.gif',	'name': FX_MESS.TBUnOList, 'cmd': 'InsertUnorderedList'}];
arButtons['InsertHorizontalRule']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/hr.gif','name': FX_MESS.TBHr, 'cmd': 'InsertHorizontalRule'}];
...
arButtons['source']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/text.gif',	'codeEditorMode': true, 'name': FX_MESS.TBSrc, 't': 'code', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('code');}}];
arButtons['wysiwyg']	=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/wysiwyg.gif',	'codeEditorMode': true, 'name': FX_MESS.TBWysiwyg, 't': 'html', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('wysiwyg');}}];
arButtons['split']		=	['BXButton', {'src': '/freetrix/images/fileman/htmledit2/split.gif',	'codeEditorMode': true, 'name': FX_MESS.TBSplitmode, 't': 'split', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('split');}}];
...
/*
arButtons['insrow']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/insrow.gif', ''];
arButtons['delrow']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/delrow.gif', ''];
arButtons['inscol']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/inscol.gif', ''];
arButtons['delcol']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/delcol.gif', ''];
arButtons['inscell']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/inscell.gif', ''];
arButtons['delcell']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/delcell.gif', ''];
arButtons['mergecell']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/mrgcell.gif', ''];
arButtons['splitcell']	=	['BXTButton', '/freetrix/images/fileman/htmledit2/spltcell.gif', ''];
...
pPropertybarHandlers['td'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			cell = row.insertCell(-1);
			pTaskbar.arElements['width_val'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropW, 'type': 'text'}));
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':'x'}));
			pTaskbar.arElements['height_val'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'5', 'title': FX_MESS.TPropH, 'type': 'text'}));
			...
			row = tProp.insertRow(-1);
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropNoWrap}));
...
pPropertybarHandlers['a'] = function (bNew, pTaskbar, pElement)
{
	...
	if(bNew)
	{
		...
		else
		{
			...
			cell = row.insertCell(-1);
			pTaskbar.arElements['href_val'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'40', 'title': FX_MESS.TPropURL, 'type': 'text'}));
			...
			cell = row.insertCell(-1);
			pTaskbar.arElements['title'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'30', 'title': FX_MESS.TPropTitle, 'type': 'text'}));

			//////
			row = tProp.insertRow(-1); cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropTarget}));
			...
			pTaskbar.arElements['target_list'] = pTaskbar.pMainObj.CreateCustomElement(
				...
				[
					{'value': '', 'name': '&nbsp;'},
					{'value': '_blank', 'name': FX_MESS.TPropTargetBlank},
					{'value': '_parent', 'name': FX_MESS.TPropTargetParent},
					{'value': '_self', 'name': FX_MESS.TPropTargetSelf},
					{'value': '_top', 'name': FX_MESS.TPropTargetTop}
				],
				'OnSelectionChange': function (){
						//this.Select(sel);
					},
			...
			pTaskbar.arElements['target'] = tTemp.rows[0].insertCell(-1).appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'13', 'title': FX_MESS.TPropTargetWin, 'type': 'text'}));
...
pPropertybarHandlers['img'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			row = tProp.insertRow(-1); cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropImgPath}));

			cell = row.insertCell(-1);
			pTaskbar.arElements['src'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'40', 'title': FX_MESS.TPropImgPath2, 'type': 'text'}));
			...
			cell = row.insertCell(-1);
			pTaskbar.arElements['alt'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'40', 'title': FX_MESS.TPropTitle, 'type': 'text'}));
			...
			cell = row.insertCell(-1);
			pTaskbar.arElements['border'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("INPUT", {'size':'4', 'title': FX_MESS.TPropImgBorder, 'type': 'text'}));
...
pPropertybarHandlers['php'] = function (bNew, pTaskbar, pElement)
{
	...
	if(bNew)
	{
		...
		row = tProp.insertRow(-1);
		cell = row.insertCell(-1);
		pTaskbar.arElements['code'] = cell.appendChild(pTaskbar.pMainObj.CreateElement("TEXTAREA", {'rows':'3', cols: '60', 'title': FX_MESS.TPropPHP}, {"width": "100%"}));
...
var BXShowComponentPanel = function (bNew, pTaskbar, pElement)
{
	...
	//////////
	var sURL = '/freetrix/admin/fileman_get_xml.php?op=componentconfig&lang='+BXLang+'&site='+BXSite+'&templateID='+templateID+'&path='+arSettings["SCRIPT_NAME"];
	...
	for(var propertyID in arParams)
	{
		...
		case "LIST":
			...
			if(arPropertyParams['ADDITIONAL_VALUES']!='N')
			{
				...
				oOption.text = (arPropertyParams['MULTIPLE']=='Y'?FX_MESS.TPropCompNS:FX_MESS.TPropCompOth)+' ->';
...
*/
	...
	if(tProp.rows.length>0 && (arTemplate = pTaskbar.pMainObj.FindComponentByPath(arSettings["SCRIPT_NAME"])))
	{
		...
		cell.noWrap = true;
		cell.insertBefore(pTaskbar.pMainObj.CreateElement("IMG", {'src': '/freetrix/images/fileman/htmledit2/info.gif', 'title': arTemplate['FULL_PATH'], 'align': 'right', 'width': '16', 'height':'16'}), cell.childNodes[0]);
	}
...
pPropertybarHandlers['default'] = function (bNew, pTaskbar, pElement)
{
	if(bNew)
	{
		...
		else
		{
			...
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropBIU}));
			...
			row = tProp.insertRow(-1);
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML': FX_MESS.TPropFFace}));
			...
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML':FX_MESS.TPropFSize}));
			...
			row = tProp.insertRow(-1);
			cell = row.insertCell(-1); cell.align = 'right';
			cell.appendChild(pTaskbar.pMainObj.CreateElement("SPAN", {'innerHTML': FX_MESS.TPropColor}));

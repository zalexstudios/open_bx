var BXConst =
{
	...
	'arColorName': [FX_MESS.CPickClr1, FX_MESS.CPickClr2, FX_MESS.CPickClr3, FX_MESS.CPickClr4, FX_MESS.CPickClr5, FX_MESS.CPickClr6, FX_MESS.CPickClr7, FX_MESS.CPickClr8,
		FX_MESS.CPickClr9, FX_MESS.CPickClr10, FX_MESS.CPickClr11, FX_MESS.CPickClr12, FX_MESS.CPickClr13, FX_MESS.CPickClr14, FX_MESS.CPickClr15, FX_MESS.CPickClr16,
		FX_MESS.CPickClr17, FX_MESS.CPickClr18, FX_MESS.CPickClr19, FX_MESS.CPickClr20, FX_MESS.CPickClr21, FX_MESS.CPickClr22, FX_MESS.CPickClr23, FX_MESS.CPickClr24,
		FX_MESS.CPickClr25, FX_MESS.CPickClr26, FX_MESS.CPickClr27, FX_MESS.CPickClr28, FX_MESS.CPickClr29, FX_MESS.CPickClr30, FX_MESS.CPickClr31, FX_MESS.CPickClr32,
		FX_MESS.CPickClr33, FX_MESS.CPickClr34, FX_MESS.CPickClr35, FX_MESS.CPickClr36, FX_MESS.CPickClr37, FX_MESS.CPickClr38, FX_MESS.CPickClr39, FX_MESS.CPickClr1]
};
...
function BXButtonSeparator()
{
	BXButtonSeparator.prototype._Create = function ()
	{
		...
		this.pWnd = this.CreateElement("IMG", {'src': '/freetrix/images/fileman/htmledit2/separator.gif', 'width': '2', 'height': '20'});
	...
	BXButtonSeparator.prototype.onToolbarChangeDirection = function (bVertical)
	{
		if(bVertical)
		{
			this.pWnd.src='/freetrix/images/fileman/htmledit2/separator-v.gif';
			this.pWnd.style.width = "20px";
			this.pWnd.style.height = "2px";
		}
		else
		{
			this.pWnd.src='/freetrix/images/fileman/htmledit2/separator.gif';
...
BXStyleList.prototype.FillList = function()
{
	...
	//"clear style" item
	this.__CreateRow('', FX_MESS.DeleteStyleOpt, {'index': this.values.length, 'value': '', 'name': FX_MESS.DeleteStyleOptTitle});
...
function _BXColorPicker()
{
	_BXColorPicker.prototype._Create = function ()
	{
		...
		this.pIcon = this.pMainObj.CreateElement("IMG", {'src': (this.icon?this.icon:'/freetrix/images/fileman/htmledit2/bgcolor.gif'), 'width': '20', 'height': '20', 'alt': this.title});
		...
		for(i=0; i<BXConst.arColor.length/iColumnCount; i++)
		{
			...
			for(j=0; j<iColumnCount; j++)
			{
				...
				c1.innerHTML = '<img src="/freetrix/images/1.gif" width="1" height="1"/>';
...
function _BXTAlignPicker()
{
	...
	this.arIconName = [
		FX_MESS.TAlign1, FX_MESS.TAlign2, FX_MESS.TAlign3,
		FX_MESS.TAlign4, FX_MESS.TAlign5, FX_MESS.TAlign6,
		FX_MESS.TAlign7, FX_MESS.TAlign8, FX_MESS.TAlign9];
	...
	_BXTAlignPicker.prototype._Create = function ()
	{
		...
		this.pIcon = this.pMainObj.CreateElement("IMG", {'src': '/freetrix/images/fileman/htmledit2/talign-tl.gif', 'width': '20', 'height': '20', 'alt': this.title});
		this.pIcon.className = 'bxedtbutton';
		cell.appendChild(this.pIcon);
		addCustomElementEvent(this.pIcon, 'mouseover', this.onMouseOver, this);
		addCustomElementEvent(this.pIcon, 'mouseout', this.onMouseOut, this);
		...
		//c.style.height = "0%";
		c.innerHTML = '<nobr>'+FX_MESS.TAlignDef+'</nobr>';
		...
		for(i=0; i<3; i++)
		{
			...
			for(j=0; j<3; j++)
			{
				...
				{
					c1 = c1.appendChild(BXPopupWindow.CreateElement("IMG", {"src": "/freetrix/images/fileman/htmledit2/1.gif", "border": 0, "alt": "", "title": ""}));
					c1.className = 'bxedtbutton';
				}
				else
				{
					c1 = c1.appendChild(BXPopupWindow.CreateElement("IMG", {"src": "/freetrix/images/fileman/htmledit2/talign-"+this.arIcon[i*3+j]+".gif", "border": 0, "alt": this.arIconName[i*3 + j], "title": this.arIconName[i*3 + j]}));
					c1.className = 'bxedtbutton';
					if(this.type == 'image')
					{
						if(j==1)
	...
	_BXTAlignPicker.prototype.SetValue = function(valH, valV)
	{
		...
		this.pIcon.src = "/freetrix/images/fileman/htmledit2/talign-"+this.arIcon[i*3+j]+".gif";
...
function BXCombo(pMainObj, id, pHandler)
{
	...
	BXCombo.prototype.Show = function()
	{
		...
		c2.appendChild(this.pMainObj.CreateElement('IMG', {'src':'/freetrix/images/fileman/htmledit2/combo_arr.gif', 'border':'0', 'width':'11', 'height':'17'}));
...
function BXDialog()
{
	BXDialog.prototype._Create = function ()
	{
		...
		if(window.showModalDialog)
			window.showModalDialog('/freetrix/admin/fileman_editor_dialog.php?lang='+BXLang+'&site='+BXSite+'&name='+this.name+'&not_use_default='+this.not_use_default, this.params, "dialogWidth:"+this.width+"px;dialogHeight:"+this.height+"px;help:no;scroll:no;status:no;center:yes;");
		else
		{
			this.pWnd = window.open('/freetrix/admin/fileman_editor_dialog.php?lang='+BXLang+'&site='+BXSite+'&name='+this.name+'&not_use_default='+this.not_use_default, 'BXDialog'+Math.random.toString().substring(2), 'height='+this.height+',width='+this.width+',toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,modal=yes,alwaysRaised=yes,dialog=yes');

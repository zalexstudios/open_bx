...
class CCodeEditor // CE
{
	public static function Show($params)
	{
		...
		$APPLICATION->AddHeadScript('/freetrix/js/fileman/code_editor/code-editor.js');
		$APPLICATION->SetAdditionalCSS('/freetrix/js/fileman/code_editor/code-editor.css');
		...
		<script>
			...
			BX.ready(function()
			{
				...
				{
					BX.loadScript('/freetrix/js/fileman/code_editor/code-editor.js?<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/js/fileman/code_editor/code-editor.js')?>', codeEditorLoaded);
					BX.loadCSS('/freetrix/js/fileman/code_editor/code-editor.css');
				}
				else
				{
					codeEditorLoaded();
	...
	{
		$langPath = $_SERVER['DOCUMENT_ROOT'].'/freetrix/modules/fileman/lang/'.LANGUAGE_ID.'/classes/general/code_editor_js.php';
		if(file_exists($langPath))
			include($langPath);
		else
			$langPath = $_SERVER['DOCUMENT_ROOT'].'/freetrix/modules/fileman/lang/en/classes/general/code_editor_js.php';

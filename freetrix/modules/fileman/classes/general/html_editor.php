...
class CHTMLEditor
{
	...
	function Show($arParams)
	{
		...
		CComponentParamsManager::Init(array(
			'requestUrl' => '/freetrix/admin/fileman_component_params.php'
		));
	}
...
<div class="bx-html-editor" id="bx-html-editor-<?=$this->id?>" style="width:<?= $width.$widthUnit?>; height:<?= $height.$heightUnit?>; <?= $display ? '' : 'display: none;'?>">
	...
	{
		$langPath = $_SERVER['DOCUMENT_ROOT'].'/freetrix/modules/fileman/lang/'.LANGUAGE_ID.'/classes/general/html_editor_js.php';
		if(!file_exists($langPath))
			$langPath = $_SERVER['DOCUMENT_ROOT'].'/freetrix/modules/fileman/lang/en/classes/general/html_editor_js.php';

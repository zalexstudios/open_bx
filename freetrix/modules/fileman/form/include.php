...
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/main/filter_tools.php");

IncludeModuleLangFile(__FILE__);
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/form/errors.php");
...
$path = $_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/form/validators";
$handle = opendir($path);
if ($handle)
{

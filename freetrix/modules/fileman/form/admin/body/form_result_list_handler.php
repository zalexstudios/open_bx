...
if (is_array($ARR_RESULT) && count($ARR_RESULT)>0 && strlen($delete)>0 && (check_freetrix_sessid() || defined("FORM_NOT_CHECK_SESSID"))) 
{
	foreach($ARR_RESULT as $rid) CFormResult::Delete($rid);
}

$del_id = intval($del_id);
if ($del_id>0 && (check_freetrix_sessid() || defined("FORM_NOT_CHECK_SESSID"))) CFormResult::Delete($del_id);

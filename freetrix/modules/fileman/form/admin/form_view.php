...
{
	if($REQUEST_METHOD == "GET" && strlen($save)>0 && $F_RIGHT >= 30 && check_freetrix_sessid())
	{
...
$APPLICATION->SetAdditionalCSS('/freetrix/components/freetrix/main.calendar/templates/.default/style.css');

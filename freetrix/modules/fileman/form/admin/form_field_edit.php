...
if ($additional!="Y")
{
	$aMenu[] = array(
		...
		"LINK"			=> "/freetrix/admin/form_field_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID,
		"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_QUESTION")."  href='/freetrix/admin/form_field_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."'>+</a>]",
...
else
{
	$aMenu[] = array(
		...
		"LINK"			=> "/freetrix/admin/form_field_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."&additional=Y",
		"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_FIELD")."  href='/freetrix/admin/form_field_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."&additional=Y'>+</a>]",
...
if ($F_RIGHT>=30 && $ID>0)
{
	...
	if ($additional=="Y")
	{
		...
		$aMenu[] = array(
			...
			"LINK"	=> "form_field_edit.php?ID=".$ID."&amp;copy_id=".$ID."&lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID. "&additional=Y&".freetrix_sessid_get()
			);
		...
		$aMenu[] = array(
			...
			"LINK"	=> "javascript:if(confirm('".GetMessage("FORM_CONFIRM_DELETE_FIELD")."'))window.location='form_field_list.php?action=delete&ID=".$ID."&WEB_FORM_ID=".$WEB_FORM_ID."&".freetrix_sessid_get()."&lang=".LANGUAGE_ID."&additional=Y';",
			);
	}
	else
	{
		...
		$aMenu[] = array(
			...
			"LINK"	=> "form_field_edit.php?ID=".$ID."&amp;copy_id=".$ID."&lang=".LANGUAGE_ID. "&WEB_FORM_ID=".$WEB_FORM_ID."&".freetrix_sessid_get()
			);
		...
		$aMenu[] = array(
			...
			"LINK"	=> "javascript:if(confirm('".GetMessage("FORM_CONFIRM_DELETE_QUESTION")."'))window.location='form_field_list.php?action=delete&ID=".$ID."&WEB_FORM_ID=".$WEB_FORM_ID."&".freetrix_sessid_get()."&lang=".LANGUAGE_ID."';",
			"WARNING"=>"Y"
			);
	}
...
$aMenu[] = array(
	...
	"LINK"			=> "/freetrix/admin/form_status_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID,
	"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_STATUS")."  href='/freetrix/admin/form_status_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."'>+</a>]",
...
$aMenu[] = array(
	...
	"LINK"			=> "/freetrix/admin/form_result_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID,
	"TEXT_PARAM"	=> ($old_module_version=="Y" || $F_RIGHT<10) ? "" : " [<a title='".GetMessage("FORM_ADD_RESULT")."' href='/freetrix/admin/form_view.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."'>+</a>]",
...
var _global_FX_UTF = <?if (defined('FX_UTF') && FX_UTF === true):?>true<?else:?>false<?endif?>;
	...
	<script src="/freetrix/js/form/form_validators.js?<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/js/form/form_validators.js')?>"></script>
	<script language="JavaScript">
var arMess = {
...
?>
	...
	?>
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_USER")?><br><img src="/freetrix/images/form/mouse.gif" width="44" height="21" border=0 alt="" /></td>
		<td><?
	...
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_ANSWER_TEXT")?><br><img src="/freetrix/images/form/mouse.gif" width="44" height="21" border=0 alt=""></td>
		<td><?
	...
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_ANSWER_VALUE")?><br><img src="/freetrix/images/form/mouse.gif" width="44" height="21" border=0 alt=""></td>
		<td><?
	...
	?>
	<tr>
		<td><?echo GetMessage("FORM_FILTER_TYPE")?>:<br><img src="/freetrix/images/form/mouse.gif" width="44" height="21" border=0 alt="" /></td>
		<td><?

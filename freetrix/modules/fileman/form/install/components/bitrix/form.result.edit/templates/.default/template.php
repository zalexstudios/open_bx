...
<table class="form-info-table data-table">
	...
	<tbody>
		...
		if ($arResult["isAccessFormParams"] == "Y")
		{
			...
			?>
				[<a title='<?=GetMessage("FORM_EDIT_USER")?>' href='/freetrix/admin/user_edit.php?lang=<?=LANGUAGE_ID?>&ID=<?=$arResult["RESULT_USER_ID"]?>'><?=$arResult["RESULT_USER_ID"]?></a>] (<?=$arResult["RESULT_USER_LOGIN"]?>) <?=CUser::FormatName($arParams["NAME_TEMPLATE"], $userName)?>

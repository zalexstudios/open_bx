...
if($REQUEST_METHOD=="POST" && is_array($files) && count($files)>0 && strlen($saveperm)>0 && check_freetrix_sessid() && $USER->CanDoOperation('fileman_admin_folders'))
{
...
<tr class="heading">
	...
	<tr>
		<td>
			[<a href="/freetrix/admin/group_edit.php?ID=<?=$g_ID?>&lang=<?=LANGUAGE_ID?>"><?=$g_ID?></a>]&nbsp;<?echo $g_NAME?>
		</td>
		<td>

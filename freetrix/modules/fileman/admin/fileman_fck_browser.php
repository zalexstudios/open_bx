...
{
	var src;
	src = "/freetrix/admin/workflow_get_file.php?cash=Y&did=<?=intval($DOCUMENT_ID)?>&wf_path=<?=urlencode($WF_PATH)?>&fname="+strPath;
	imageupload.url.value=strPath;
	if(imageupload.preview)
...
<td valign="top" width="98%" align="center">
	...
	<img src="/freetrix/images/1.gif" width="100" name="preview">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="100%"><input class="typeinput" type="text" name="url" size="40" value=""><img src="/freetrix/images/1.gif" width="2" height="1" border=0 alt=""><input class="button" type="button" name="bSelect" onclick="SelectImage(imageupload.url.value)" value="<?=GetMessage('FILEMAN_SELECT_IMAGE')?>"></font></td>
	</tr>
	<tr>

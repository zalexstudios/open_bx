...
if(!$USER->CanDoFileOperation('fm_download_file', $arPath) || HasScriptExtension($path)):
	ShowError($arParsedPath["HTML"].'<br><br><img src="/freetrix/images/fileman/deny.gif" width="28" height="28" border="0" align="left" alt="">'.GetMessage("ACCESS_DENIED"));
else:
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
	...
	<tr>
		<td class="tablebody1" align="left">
			...
			<tr>
				<td align="left"><font class="tablebodytext"><a href="fileman_file_list.php?lang=<?=LANG?>&site=<?=Urlencode($site)?>&path=<?=UrlEncode($arParsedPath["PREV"])?>&type=<?=urlencode($type)?>"><IMG SRC="/freetrix/images/fileman/folder.gif" WIDTH="17" HEIGHT="15" BORDER=0 ALT=""></a></font></td>
	...
	<tr valign="top">
		<td class="tablebody1">
			<table cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td align="left"><font class="tablebodytext"><a href="fileman_file_list.php?lang=<?=LANG?>&site=<?=Urlencode($site)?>&path=<?=UrlEncode(htmlspecialcharsex($path)."/".$Dir["NAME"])?>&type=<?=urlencode($type)?>"><IMG SRC="/freetrix/images/fileman/folder.gif" WIDTH="17" HEIGHT="15" BORDER=0 ALT=""></a></font></td>
	...
	<tr valign="top">
		<td class="tablebody1">
			<table cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td align="left"><a onclick="OpenFile('<?=AddSlashes(htmlspecialcharsex($File["NAME"]))?>','<?=AddSlashes(htmlspecialcharsex($path))?>'); return false;" href="javascript:void(0)"><IMG SRC="/freetrix/images/fileman/file.gif" width="15" height="18"></a></td>

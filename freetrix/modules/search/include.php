...
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/search/tools/stemming.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/search/tools/tags.php");

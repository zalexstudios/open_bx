<?
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].FX_ROOT."/modules/main/options.php");
IncludeModuleLangFile(__FILE__);
require_once($_SERVER["DOCUMENT_ROOT"]."/freetrix/modules/search/prolog.php");
	...
	array(
		...
		"OPTIONS" => Array(
			...
			"full_text_engine" => Array(GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE"), Array("select", array(
				"freetrix" => GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE_FREETRIX"),
				"sphinx" => GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE_SPHINX"),
			))),
			"letters" => Array(GetMessage("SEARCH_OPTIONS_LETTERS"), Array("text", 45), "freetrix"),
	...
	array(
		...
		"OPTIONS" => Array(
			...
			"use_word_distance" => Array(
				...
				Array("checkbox", "N"),
				"disabled" => FX_SEARCH_VERSION > 1? "": GetMessage("SEARCH_OPTIONS_REINSTALL_MODULE"),
			),

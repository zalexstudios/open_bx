...
global $FX_TV_PREFIX;
if(!isset($FX_TV_PREFIX))
	$FX_TV_PREFIX = 0;
else
	$FX_TV_PREFIX = intval($FX_TV_PREFIX)+1;

$arResult['FIRST_FLV_ITEM'] = false;
$arResult['FIRST_WMV_ITEM'] = false;

if($this->StartResultCache(false, array(($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $FX_TV_PREFIX)))
{
...
//include js
$APPLICATION->AddHeadString('<script type="text/javascript" src="/freetrix/components/freetrix/player/wmvplayer/silverlight.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/player/wmvplayer/silverlight.js').'"></script>', true);
$APPLICATION->AddHeadString('<script type="text/javascript" src="/freetrix/components/freetrix/player/wmvplayer/wmvplayer.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/player/wmvplayer/wmvplayer.js').'"></script>', true);
$APPLICATION->AddHeadString('<script type="text/javascript" src="/freetrix/components/freetrix/player/mediaplayer/flvscript.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/player/mediaplayer/flvscript.js').'"></script>', true);
CUtil::InitJSCore();

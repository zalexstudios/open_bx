...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/map.google.search/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/freetrix/components/freetrix/map.google.search/settings/settings_load.js"></script>
<script type="text/javascript">
BX.loadCSS('/freetrix/components/freetrix/map.google.search/settings/settings.css');
...
<?
$APPLICATION->IncludeComponent('freetrix:map.google.system', '', array(
	'KEY' => $_REQUEST['KEY'],

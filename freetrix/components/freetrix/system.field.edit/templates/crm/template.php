...
$APPLICATION->SetAdditionalCSS('/freetrix/js/crm/css/crm.css');
$APPLICATION->AddHeadScript('/freetrix/js/crm/crm.js');
...
<script type="text/javascript">
	var _FX_CRM_FIELD_INIT_<?=$funcSuffix?> = function()
	{
		if(typeof(CRM) == 'undefined')
		{
			BX.loadCSS('/freetrix/js/crm/css/crm.css');
			BX.loadScript('/freetrix/js/crm/crm.js', _FX_CRM_FIELD_INIT_<?=$funcSuffix?>);
			return;
		}
	...
	BX.ready(
		function()
		{
			...
			window.setTimeout(_FX_CRM_FIELD_INIT_<?=$funcSuffix?>, 100);
		}
	);
</script>
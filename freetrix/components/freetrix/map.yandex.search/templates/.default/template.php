...
?>
<img src="/freetrix/components/freetrix/map.yandex.search/templates/.default/images/screenshot.png" border="0" />
<?
else:
?>
...
<?
	...
	$APPLICATION->IncludeComponent('freetrix:map.yandex.system', '.default', $arParams, null, array('HIDE_ICONS' => 'Y'));
?>
	</div>

...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/map.yandex.search/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/freetrix/components/freetrix/map.yandex.search/settings/settings_load.js"></script>
<script type="text/javascript">
jsUtils.loadCSSFile('/freetrix/components/freetrix/map.yandex.search/settings/settings.css');

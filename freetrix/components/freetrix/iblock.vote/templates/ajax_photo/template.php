...
if ($arParams["INCLUDE_JS_FILE"] != "N")
	$GLOBALS['APPLICATION']->AddHeadScript('/freetrix/components/freetrix/iblock.vote/templates/ajax_photo/script1.js');
...
// Don't delete <!--FX_PHOTO_RATING-->, <!--FX_PHOTO_RATING_END--> comments - they are used in js to catch html content in photogallery
?>
<!--FX_PHOTO_RATING-->

...
window.BlogBFileDialog = function(arParams)
{
	...
	if (!!BX.FileUploadAgent) {
		...
		BX.debug('/freetrix/components/freetrix/main.file.input/templates/drag_n_drop/script.js: BX.FileUploadAgent is not defined.' +
			' You need to load /freetrix/js/main/file_upload_agent.js');
	}
}
...
window.BlogBFileDialogDispatcher = function(controller)
{
	...
	BX.loadScript('/freetrix/js/main/core/core_dd.js', BX.delegate(function() {
...
window.BlogBFileDialogUploader = function(arParams, agent)
{
	...
	BX.loadScript('/freetrix/js/main/core/core_dd.js', BX.delegate(
		function() {
...
window.MFIDD = function(params){
	BX.loadCSS('/freetrix/components/freetrix/main.file.input/templates/drag_n_drop/style.css');

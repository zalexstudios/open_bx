...
CFreetrixComponent::includeComponentClass("freetrix::news.base");
class CFreetrixCatalogSmartFilter extends CFreetrixNewsBase
*/
class CFreetrixCatalogSmartFilter extends CFreetrixComponent
{
	var $IBLOCK_ID = 0;
	var $SKU_IBLOCK_ID = 0;

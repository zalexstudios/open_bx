...
$APPLICATION->IncludeComponent('freetrix:map.google.system', '.default', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
...
function FX_SetPlacemarks_<?echo $arParams['MAP_ID']?>()
{
<?
	for($i = 0; $i < $cnt; $i++):
?>
	FX_GMapAddPlacemark(<?echo CUtil::PhpToJsObject($arResult['POSITION']['PLACEMARKS'][$i])?>, '<?echo $arParams['MAP_ID']?>');
<?
	endfor;
?>
}

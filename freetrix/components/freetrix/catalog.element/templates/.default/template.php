...
<?
	...
	if ($useBrands)
	{
		?><?$APPLICATION->IncludeComponent("freetrix:catalog.brandblock", ".default", array(
			"IBLOCK_TYPE" => $arParams['IBLOCK_TYPE'],
			"IBLOCK_ID" => $arParams['IBLOCK_ID'],
			"ELEMENT_ID" => $arResult['ID'],
			"ELEMENT_CODE" => "",
...
<?$APPLICATION->IncludeComponent("freetrix:catalog.set.constructor",
	".default",
	array(
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"BLOG_TITLE" => "",
		"BLOG_URL" => "",
		"PATH_TO_SMILE" => "/freetrix/images/blog/smile/",
		"EMAIL_NOTIFY" => "N",
		"AJAX_POST" => "Y",
		"SHOW_SPAM" => "Y",
		"SHOW_RATING" => "N",

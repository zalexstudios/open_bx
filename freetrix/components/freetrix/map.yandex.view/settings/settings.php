...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/map.yandex.view/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/freetrix/components/freetrix/map.yandex.view/settings/settings_load.js"></script>
<script type="text/javascript">
BX.loadCSS('/freetrix/components/freetrix/map.yandex.view/settings/settings.css');
window._global_FX_UTF = <?echo defined('FX_UTF') && FX_UTF == true ? 'true' : 'false'?>;
window.jsYandexMess = {
...
<?
$APPLICATION->IncludeComponent('freetrix:main.colorpicker', '', array('SHOW_BUTTON' => 'N'), false, array('HIDE_ICONS' => 'Y'));

$APPLICATION->IncludeComponent('freetrix:map.yandex.system', '', array(
	'KEY' => $_REQUEST['KEY'],

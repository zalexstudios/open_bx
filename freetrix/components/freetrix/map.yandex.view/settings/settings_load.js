...
CBXYandexPoly.prototype.prepareSettingsForm = function()
{
	...
	this.EDIT_CONTROL.FX_POLYLINE = this;
	...
	obContainer.innerHTML = '<b>' + window.jsYandexMess.poly_opt_header + '</b>' +
		...
		'<tr><td><span style="font-size: 11px;">' + window.jsYandexMess.poly_opt_title + '</span></td><td><input type="text" value="" style="width: 125px;" onkeyup="this.form.FX_POLYLINE.setTitle(this.value)" /></td></tr>' +
		'<tr><td><span style="font-size: 11px;">' + window.jsYandexMess.poly_opt_color + '</span></td><td><input type="text" value="' + this.STYLE.strokeColor.substring(0,6) + '" style="width: 100px; float: left;" onkeyup="this.form.FX_POLYLINE.setStyle(\'color\', this.value, this)" /></td></tr>' +
		'<tr><td><span style="font-size: 11px;">' + window.jsYandexMess.poly_opt_width + '</span></td><td><input type="text" value="' + this.STYLE.strokeWidth + '"  style="width: 125px;"onkeyup="this.form.FX_POLYLINE.setStyle(\'width\', this.value, this)" /></td></tr>' +
		'<tr><td><span style="font-size: 11px;">' + window.jsYandexMess.poly_opt_opacity + '</span></td><td><input type="text" value="' + Math.round(parseInt('0x' + this.STYLE.strokeColor.substring(6))/2.55) + '" style="width: 125px;"onkeyup="this.form.FX_POLYLINE.setStyle(\'opacity\', this.value, this)" /></td></tr>' +
		'</table>';
...
var jsYandexCE = {
	...
	init: function(map)
	{
		...
		BX.loadCSS([
			'/freetrix/components/freetrix/map.yandex.system/templates/.default/style.css',
			'/freetrix/components/freetrix/map.yandex.view/settings/settings_iframe.css'
		]);
		BX.loadScript('/freetrix/components/freetrix/main.colorpicker/templates/.default/script.js', function() {

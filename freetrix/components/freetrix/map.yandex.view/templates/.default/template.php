...
if ($arParams['FX_EDITOR_RENDER_MODE'] == 'Y'):
?>
<img src="/freetrix/components/freetrix/map.yandex.view/templates/.default/images/screenshot.png" border="0" />
<?
else:
	...
	$arTransParams = array(
		...
		'ONMAPREADY' => 'FX_SetPlacemarks_'.$arParams['MAP_ID'],
	);
...
function FX_SetPlacemarks_<?echo $arParams['MAP_ID']?>(map)
{
	if(typeof window["FX_YMapAddPlacemark"] != 'function')
	{
		...
		*/
		...
		var ymWaitIntervalId = setInterval( function(){
				if(typeof window["FX_YMapAddPlacemark"] == 'function')
				{
					FX_SetPlacemarks_<?echo $arParams['MAP_ID']?>(map);
...
<?
	$APPLICATION->IncludeComponent('freetrix:map.yandex.system', '.default', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
<?

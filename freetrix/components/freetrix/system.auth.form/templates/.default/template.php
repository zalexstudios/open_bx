...
<?if ($arResult["CAPTCHA_CODE"]):?>
		<tr>
			...
			<img src="/freetrix/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" /><br /><br />
...
<?
$APPLICATION->IncludeComponent("freetrix:socserv.auth.form", "icons", 
	array(
...
<?if($arResult["AUTH_SERVICES"]):?>
<?
$APPLICATION->IncludeComponent("freetrix:socserv.auth.form", "", 
	array(
		"AUTH_SERVICES"=>$arResult["AUTH_SERVICES"],

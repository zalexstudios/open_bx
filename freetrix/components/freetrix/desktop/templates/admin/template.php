...
if(!defined("FX_GADGET_DEFAULT"))
{
	define("FX_GADGET_DEFAULT", true);
	?>
	<script type="text/javascript">
	var updateURL = '<?=CUtil::JSEscape(htmlspecialcharsback($arResult['UPD_URL']))?>';
	var bxsessid = '<?=CUtil::JSEscape(freetrix_sessid())?>';
	...
	if($arResult["PERMISSION"] > "R"):?>
		<script type="text/javascript" src="/freetrix/components/freetrix/desktop/script.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/desktop/script.js');?>"></script>
		<script type="text/javascript" src="/freetrix/components/freetrix/desktop/templates/admin/script_admin.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/desktop/templates/admin/script_admin.js');?>"></script>	
	<?endif?>

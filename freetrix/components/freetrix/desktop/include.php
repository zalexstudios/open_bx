...
CComponentUtil::__IncludeLang("/freetrix/components/freetrix/desktop/", "/include.php");
			...
			foreach($arGdNS as $NS)
			{
				...
				if(is_dir($gdDir."/".$id))
				{
					...
					if($arDescription["ICON"] && substr($arDescription["ICON"], 0, 1)!="/")
						$arDescription["ICON"] = "/freetrix/gadgets/".$NS."/".$id."/".$arDescription["ICON"];

...
<?if ($arResult['AJAX_MODE'] == 'Y'):?>
	BX.loadCSS('/freetrix/components/freetrix/rating.vote/templates/like/popup.css');
	BX.loadCSS('/freetrix/components/freetrix/rating.vote/templates/like_graphic/style.css');
	BX.loadScript('/freetrix/js/main/rating_like.js', function() {
<?endif;?>

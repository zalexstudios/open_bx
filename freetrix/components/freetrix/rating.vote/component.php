...
$isMobileLog = defined("FX_MOBILE_LOG") && FX_MOBILE_LOG == true;
...
if (!(isset($arParams['TEMPLATE_HIDE']) && $arParams['TEMPLATE_HIDE'] == 'Y'))
{
	if (!defined('MAIN_RATING_VOTE_JS_INCLUDE'))
	{
		...
		{
			if ($isLikeTemplate)
				$APPLICATION->AddHeadScript("/freetrix/js/main/rating_like.js");
			else
				$APPLICATION->AddHeadScript("/freetrix/js/main/rating.js");
		}
	}
	if (!$isMobileLog)
		$APPLICATION->SetAdditionalCSS("/freetrix/components/freetrix/rating.vote/templates/like/popup.css");

...
ShowPopup: function()
{
	...
	if (this.pCont)
		jsUtils.addEvent(this.pCont, "scroll", window.FX_PLAYER_SKIN_PARAM_CLOSE);
	...
	// Add events
	jsUtils.addEvent(document, "keypress", window.FX_PLAYER_SKIN_PARAM_CLOSE);
	setTimeout(function(){jsUtils.addEvent(document, "click", window.FX_PLAYER_SKIN_PARAM_CLOSE);}, 10);
},
...
ClosePopup: function()
{
	...
	jsUtils.removeEvent(document, "keypress", window.FX_PLAYER_SKIN_PARAM_CLOSE);
	jsUtils.removeEvent(document, "click", window.FX_PLAYER_SKIN_PARAM_CLOSE);
	if (this.pCont)
		jsUtils.removeEvent(this.pCont, "scroll", window.FX_PLAYER_SKIN_PARAM_CLOSE);
...
{	
	...
	{			
		...
		{
			pDiv.appendChild(jsUtils.CreateElement("IMG", {src: '/freetrix/components/freetrix/player/images/default_skin.png'}));
		}
	...
	window.FX_PLAYER_SKIN_PARAM_CLOSE = function(e){_this.ClosePopup();};
},

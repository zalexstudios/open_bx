...
if (!window.style_2 || !window.style_2.parentNode)
	window.style_2 = jsUtils.loadCSSFile("/freetrix/components/freetrix/player/js/playlist_edit.css");
</script>
<script type="text/javascript" src="/freetrix/js/main/dd.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/js/main/dd.js')?>"></script>
<script type="text/javascript" src="/freetrix/components/freetrix/player/js/playlist_edit.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/freetrix/components/freetrix/player/js/playlist_edit.js')?>"></script>
<?

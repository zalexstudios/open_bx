...
if ($arCurrentValues["USE_PLAYLIST"] == 'Y')
{
	...
	$arParams["PLAYLIST_DIALOG"] = Array(
		...
		"TYPE" => "CUSTOM",
		"JS_FILE" => "/freetrix/components/freetrix/player/js/prop_playlist_edit.js",
...
if ($type != 'wmv')
{
	$arParams["SKIN_PATH"] = Array(
		...
		"FD_TARGET" => "D",
		"FD_UPLOAD" => false,
		"DEFAULT" => "/freetrix/components/freetrix/player/mediaplayer/skins",
		"REFRESH" => "Y",
		"HIDDEN" => $hidden,
	);

	$arSkins = getSkinsEx($arCurrentValues['SKIN_PATH'] ? $arCurrentValues['SKIN_PATH'] : "/freetrix/components/freetrix/player/mediaplayer/skins");
	//print_r($arSkins);
	...
	$arParams["SKIN"] = Array(
		...
		"TYPE" => "CUSTOM",
		"JS_FILE" => "/freetrix/components/freetrix/player/js/prop_skin_selector.js",

	...
	<table cellspacing="0" border="0" class="reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
		...
		<?if ($arParams["SHOW_AVATAR"] == "Y") { ?>
			<div class="review-avatar">
				...
				if(isset($res["AVATAR"]["HTML"]) > 0)
					...
					echo '<img src="/freetrix/components/freetrix/forum.topic.reviews/templates/.default/images/noavatar.gif" border="0" />';
				?>
			</div>
		<? } ?>
		<?if ($arParams["SHOW_RATING"] == "Y") {?>
			<div class="review-rating rating_vote_graphic">
				...
				$GLOBALS["APPLICATION"]->IncludeComponent( "freetrix:rating.vote", $arParams["RATING_TYPE"], $arRatingParams, $component, array("HIDE_ICONS" => "Y"));
				?>
			</div>
		<? } ?>
<div>
...
<?
	...
	?><div class="reviews-message-img"><?
		?><?$GLOBALS["APPLICATION"]->IncludeComponent(
			"freetrix:forum.interface", "show_file",
			Array(
				"FILE" => $arFile,
...
?>
		<div class="reviews-reply-field reviews-reply-field-captcha">
			...
			<div class="reviews-reply-field-captcha-image">
				<img src="/freetrix/tools/captcha.php?captcha_code=<?=$arResult["CAPTCHA_CODE"]?>" alt="<?=GetMessage("F_CAPTCHA_TITLE")?>" />
			</div>
		</div>
<?
endif;
...
?>
			<div class="reviews-uploaded-file">
				...
				<label for="FILES_TO_UPLOAD_<?=$key?>"><?=$val["ORIGINAL_NAME"]?> (<?=$val["CONTENT_TYPE"]?>) <?=$sFileSize?>
					( <a href="/freetrix/components/freetrix/forum.interface/show_file.php?action=download&amp;fid=<?=$key?>"><?=GetMessage("F_DOWNLOAD")?></a> )
				</label>
			</div>
<?
	endforeach;
...
if (typeof phpVars != "object")
	var phpVars = {};
phpVars.freetrix_sessid = '<?=freetrix_sessid()?>';

...
?>
<?
if (\Freetrix\Main\ModuleManager::isModuleInstalled("sale"))
{
	$arRecomData = array();
	...
	{
		?><?$APPLICATION->IncludeComponent("freetrix:sale.bestsellers", ".default", array(
			"HIDE_NOT_AVAILABLE" => $arParams["HIDE_NOT_AVAILABLE"],

...
if (0 < $ElementID)
{
	...
	$APPLICATION->IncludeComponent(
		"freetrix:catalog.recommended.products",
		"",
		array(
	...
	if($arParams["USE_ALSO_BUY"] == "Y" && \Freetrix\Main\ModuleManager::isModuleInstalled("sale") && !empty($arRecomData))
	{
		?><?$APPLICATION->IncludeComponent("freetrix:sale.recommended.products", ".default", array(
			"ID" => $ElementID,
			"TEMPLATE_THEME" => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
...
?><?
	...
	if($arParams["USE_STORE"] == "Y" && \Freetrix\Main\ModuleManager::isModuleInstalled("catalog"))
	{
		?><?$APPLICATION->IncludeComponent("freetrix:catalog.store.amount", ".default", array(
		"PER_PAGE" => "10",

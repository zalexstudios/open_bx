...
if (!defined('FX_YMAP_SCRIPT_LOADED'))
{
	$scheme = (CMain::IsHTTPS() ? "https" : "http");
	$arResult['MAPS_SCRIPT_URL'] = $scheme.'://api-maps.yandex.ru/'.$arParams['YANDEX_VERSION'].'/?load=package.full&mode=release&lang='.$arParams['LOCALE'].'&wizard=freetrix';
	if ($arParams['DEV_MODE'] != 'Y')
	{
		...
		define('FX_YMAP_SCRIPT_LOADED', 1);
	}
}

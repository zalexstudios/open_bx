...
if($componentPage=="search")
{
	...
	global $FX_NEWS_DETAIL_URL, $FX_NEWS_SECTION_URL;
	$FX_NEWS_DETAIL_URL = $arResult["FOLDER"].$arResult["URL_TEMPLATES"]["detail"];
	$FX_NEWS_SECTION_URL = $arResult["FOLDER"].$arResult["URL_TEMPLATES"]["section"];

...
class CNewsTools
{
	...
	{
		global $DB, $FX_NEWS_DETAIL_URL, $FX_NEWS_SECTION_URL;
		...
		if(substr($arFields["ITEM_ID"], 0, 1) !== 'S')
			return CIBlock::ReplaceDetailUrl($FX_NEWS_DETAIL_URL, $arr, true, "E");
		else
			return CIBlock::ReplaceDetailUrl($FX_NEWS_SECTION_URL, $arr, true, "S");
	}
}
?>

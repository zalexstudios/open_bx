function BxInterfaceGrid(table_id)
{
	...
	this.SaveColumns = function(columns)
	{
		...
		BX.ajax.get('/freetrix/components'+_this.vars.component_path+'/settings.php?GRID_ID='+_this.table_id+'&action=showcolumns&columns='+sCols+'&sessid='+_this.vars.sessid, function(){_this.Reload()});
	};
	...
	this.SetTheme = function(menuItem, theme)
	{
		...
		BX.ajax.get('/freetrix/components'+_this.vars.component_path+'/settings.php?GRID_ID='+_this.table_id+'&action=settheme&theme='+theme+'&sessid='+_this.vars.sessid);
	};
	...
	this.SetView = function(view_id)
	{
		...
		BX.ajax.get('/freetrix/components'+_this.vars.component_path+'/settings.php?GRID_ID='+_this.table_id+'&action=setview&view_id='+view_id+'&sessid='+_this.vars.sessid, func);
	};
	...
	this.DeleteView = function(view_id)
	{
		...
		BX.ajax.get('/freetrix/components'+this.vars.component_path+'/settings.php?GRID_ID='+this.table_id+'&action=delview&view_id='+view_id+'&sessid='+_this.vars.sessid);
	};
	...
	this.SaveSettings = function(view_id, doReload)
	{
		...
		BX.ajax.post('/freetrix/components'+_this.vars.component_path+'/settings.php', data, handler);
	...
	this.SaveFilterRows = function()
	{
		...
		BX.ajax.get('/freetrix/components'+this.vars.component_path+'/settings.php?GRID_ID='+this.table_id+'&action=filterrows&rows='+sRows+'&sessid='+this.vars.sessid);
	};
	...
	this.SwitchFilter = function(a)
	{
		...
		BX.ajax.get('/freetrix/components'+this.vars.component_path+'/settings.php?GRID_ID='+this.table_id+'&action=filterswitch&show='+(on? 'N':'Y')+'&sessid='+this.vars.sessid);
	};
	...
	this.DeleteFilter = function(filter_id)
	{
		...
		BX.ajax.get('/freetrix/components'+this.vars.component_path+'/settings.php?GRID_ID='+this.table_id+'&action=delfilter&filter_id='+filter_id+'&sessid='+_this.vars.sessid);
	};
	...
	this.SaveFilter = function(filter_id)
	{
		...
		BX.ajax.post('/freetrix/components'+_this.vars.component_path+'/settings.php', data);

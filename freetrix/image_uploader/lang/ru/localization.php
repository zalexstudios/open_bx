<?
$MESS ['instructionsCommon'] = "<div class='iu-help'><b>Для загрузки файлов необходимо установить дополнительное ПО Freetrix.inc.</b>";
$MESS ['instructionsNotWinXPSP2'] = "Перезагрузите страницу нажатием клавиши F5 и нажмите кнопку \"Да\" в диалоговом окне установки.";
$MESS ['instructionsWinXPSP2'] = "<ol><li>Если вверху экрана появилось предупреждение, наведите курсор мыши в область информационной панели и нажмите правую клавишу мыши. В появившемся меню выберите пункт меню 'Установить элемент ActiveX'; <img src='/freetrix/image_uploader/images/help/notification_ru.png' height='103' /></li><li>После перезагрузки страницы в появившемся окне нажмите на кнопку 'Установить'. Если такое же окно появится и при след. перезагрузке страницы, нажмите на кнопку 'Установить'. <img src='/freetrix/image_uploader/images/help/window_ru.gif' height='209' /></li></ol>";
